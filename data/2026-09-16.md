...
### [1] [Automated Comment Moderation Enhances Social Media Advertising Performance](https://arxiv.org/abs/2609.16005)
...
### [2] [Social Behavior Among Autonomous AI: How Large Language Models Interact in Dynamic Networks](https://arxiv.org/abs/2609.16013)
...
### [3] [Digital Persuasion: Understanding the Impact of Online Influencers on Public Opinion](https://arxiv.org/abs/2609.16062)
...
### [4] [Predicting Social Media Engagement using Machine Learning](https://arxiv.org/abs/2609.16082)
...
### [5] [netseg: a Python Package for Measuring Structural Polarization and Segregation in Social Networks](https://arxiv.org/abs/2609.16088)
...
### [6] [On the Expressive Power of Implicit Line-Graph Higher-Order Weisfeiler--Leman](https://arxiv.org/abs/2609.16412)
*Fan Yang*
...
### [7] [Inferring Temporal Dependencies from Social Time Series with the Cross-Correlogram](https://arxiv.org/abs/2609.16633)
...
### [8] [The Local-to-Global AD-k Conjecture is Resolved](https://arxiv.org/abs/2609.16663)
*Wei Chen*
...
### [9] [WCCS: Efficient Wedge Conductance Community Search over Large Temporal Bipartite Graphs (Full Paper)](https://arxiv.org/abs/2609.16882)
...
### [10] [Graphlets as structural fingerprints of complex networks](https://arxiv.org/abs/2609.17445)
...
### [11] [Optimal Pruning for Neural Architectures using Fisher Information Distances](https://arxiv.org/abs/2609.16129)
...
### [12] [Safe Error Correction for Language Models: Frozen-Base Adjustment with Capability Preservation](https://arxiv.org/abs/2609.16145)
*Gautam Kishore*
...
### [13] [GPEvac: GNN-Based PPO for Adaptive Evacuation Routing During Shooting Events](https://arxiv.org/abs/2609.16163)
...
### [14] [Position: AI Is Not Ready for Strategic Conflicts](https://arxiv.org/abs/2609.16189)
...
### [15] [Calibrate, Then Route: A Measured Study of Learned Request Routing for Disaggregated LLM Serving](https://arxiv.org/abs/2609.16206)
...
### [16] [Artificial intelligence and biosecurity: capabilities, threat pathways, and defense-in-depth governance](https://arxiv.org/abs/2609.16213)
...
### [17] [Where Should the KV Cache Live? Placement Policies Across GPU, CPU, and SSD for Long-Lived Sessions](https://arxiv.org/abs/2609.16215)
*Srikanta Datta Tumkur,Jay Iyer,Mehar Simhadri,Sai Pavan Kumar,Sai Kapil Kumar,Ramesh Nampelly*
...
### [18] [Toward Governance-Aware Autonomous GIS: A Narrative Review of Ethical and Privacy Risks in LLM-Enabled GeoAI](https://arxiv.org/abs/2609.16232)
...
### [19] [Metacognitive Steering: Learning the Structure of Scientific Judgment](https://arxiv.org/abs/2609.16245)
...
### [20] [LSREP: A Longitudinal State-Replay Protocol for Evaluating Conversational Memory, with ICE v2 as an Audited Local-First Architecture](https://arxiv.org/abs/2609.16730)
*Deepesh Sonar*
...
### [21] [The Pain Axis: LLMs Represent Self-Directed Harm and Act to Relieve It](https://arxiv.org/abs/2609.16247)
...
### [22] [Can We Do Interpretable NLI with Graphs Based on Atomic Propositions?](https://arxiv.org/abs/2609.16814)
...
### [50] [Execution Flexibility in Automated Planning: A Comparative Evaluation of Deordering and Reordering Strategies](https://arxiv.org/abs/2609.16822)
...
### [51] [CoAdapt: An LLM-based Framework for Adaptive Collaborative Perception in IIoT Robotic Swarms](https://arxiv.org/abs/2609.16852)
...
### [52] [Bridging Learned Visual Perception and Symbolic Belief-Space Planning](https://arxiv.org/abs/2609.16884)
...
### [53] [QART: A Quantum-Classical Hybrid Architecture for Long-Horizon Reasoning -- Exploring a Conditional Path toward Quantum Scaling](https://arxiv.org/abs/2609.16887)
...
### [54] [AntennaFlow: A Generative Flow Model for Offset Correction in Phaseless Antenna Testing](https://arxiv.org/abs/2609.16948)
...
### [55] [Affect-Prototype Guided Fusion for Open-Vocabulary Incomplete Multi-modal Emotion Recognition](https://arxiv.org/abs/2609.16962)
...
### [56] [FlexEE: Self-Speculative and KV-Compatible Early Exiting for Offloading-Aware LLM Inference](https://arxiv.org/abs/2609.17008)
...
### [57] [ThinkFlow: Self-Evolving Probabilistic Latent Memory for Lifelong Conversational Agents](https://arxiv.org/abs/2609.17010)
...
### [58] [ORDER: Task-Conditioned Routing for Retrieval-Augmented Generation](https://arxiv.org/abs/2609.17012)
...
### [59] [SKIP: a Self-knowledge-guided Step-wise Preference Learning Framework for Concise Reasoning](https://arxiv.org/abs/2609.17019)
...
### [60] [Sparse MLLM Anchors, Dense Adaptation: Breaking the Self-Referential Loop in Wild Test-Time Adaptation](https://arxiv.org/abs/2609.17040)
...
### [61] [Sample-Conditioned Representation Selection for Audio Few-Shot Learning](https://arxiv.org/abs/2609.17076)
...
### [62] [Interactive Memory Learning for Long-Term Conversations](https://arxiv.org/abs/2609.17088)
...
### [63] [Scaling-Score Conformal Prediction for Multi-Target Regression](https://arxiv.org/abs/2609.17091)
...
### [64] [Semi-Supervised Learning-Based Genetic Biomarkers Dataset for Multiple-Stage Hepatocellular Carcinoma Prediction](https://arxiv.org/abs/2609.17100)
...
### [65] [Symbolic Separation: Grounding Deep Agents in Knowledge Graphs for Trustworthy Operational Data Analytics](https://arxiv.org/abs/2609.17107)
...
### [66] [Shared-Prefix KV Reuse Across Standard LoRA Adapters: Quality and Serving Tradeoffs](https://arxiv.org/abs/2609.17109)
*Dushyant Rajput*
...
### [67] [FirmCORe: A Benchmark for Structured Reasoning about Inter-Firm Collaboration Opportunities](https://arxiv.org/abs/2609.17128)
...
### [68] [MOCC-R1: Reinforcing Reasoning-Response Consistency for Multimodal Counselor Response Generation](https://arxiv.org/abs/2609.17180)
...
### [69] [End-to-End Latency-Minimizing and Load-Balanced Request Scheduling for Edge LLM Inference in Agentic AI Services](https://arxiv.org/abs/2609.17193)
...
### [70] [Extracting ontology-compliant knowledge from scientific text describing irradiated materials using large language models](https://arxiv.org/abs/2609.17291)
...
### [71] [Intrinsic Motivation in Reinforcement Learning: A Research Agenda for Adaptive Self-Organisation](https://arxiv.org/abs/2609.17325)
*Anatoly Belikov*
...
### [72] [From Transient Prompts to Persistent Control: Scientific Poster Generation via Recursive Semantic-Geometric Contracts](https://arxiv.org/abs/2609.17326)
...
### [73] [Self-Emergence Agent Architecture:Behavior-Inertia HMM, Reflexive Metacognition,and Social-Contrastive Self-Modeling](https://arxiv.org/abs/2609.17331)
*Xiaoyang Liu*
...
### [74] [FlashVector: Agent for Hierarchical Model Serving Stack Optimization](https://arxiv.org/abs/2609.17391)
...
### [75] [Never Stop Thinking: Continuous-Time Language Agents](https://arxiv.org/abs/2609.17416)
*Bojie Li,Noah Shi*
...
### [76] [World Model Science: Self-Organized Criticality, Weak Chaos, and Metastable Belief Dynamics in Long-Horizon LLM Agents](https://arxiv.org/abs/2609.17419)
...
### [77] [Transformer-Based Token Fusion and Dynamic Graph Planning for Audio-Visual Navigation](https://arxiv.org/abs/2609.17421)
...
### [78] [Talking Head Synthesis with Facial Landmark Guidance via 3D Gaussian Splatting](https://arxiv.org/abs/2609.17422)
...
### [79] [JustFit: 200K-Token LLM Serving on a 24 GiB Laptop with Just-in-Time State Management](https://arxiv.org/abs/2609.17475)
*Yuhua Chen*
...
### [80] [LimiX-2: A Contextual Mechanism Network Towards General Structured-Data Intelligence](https://arxiv.org/abs/2609.17488)
...
### [81] [Verifiable Social Reasoning for LLM Assistants](https://arxiv.org/abs/2609.17496)
...
### [82] [ScienceBuddy: Recursive-in-Recursive Self-Improvement for Interactive Scientific Agents](https://arxiv.org/abs/2609.17523)
...
### [83] [Evaluating Brand Retrieval and Ranking in Large Language Model Recommendations](https://arxiv.org/abs/2609.16304)
...
### [84] [Where Post-Training Quantization Breaks Text Embedders: A Measured Map Across Four Embedder Families](https://arxiv.org/abs/2609.16391)
*Hyojung Han*
...
### [85] [Balancing Trial and Reorder: A Hybrid Sequential Transformer-GBDT Ranker for On-Demand Delivery](https://arxiv.org/abs/2609.16407)
...
### [86] [PCap: Personalized Retrieval-Stage Diversity Capping in Facebook Marketplace](https://arxiv.org/abs/2609.16452)
...
### [87] [Predicting Partial Answer Quality and Utility in Agentic Retrieval-Augmented Generation](https://arxiv.org/abs/2609.16453)
...
### [88] [ReliGRec: Reliability-Oriented LLM-Based Generative Recommendation via User-Risk-Aware Prompt Routing](https://arxiv.org/abs/2609.16560)
...
### [89] [Measuring Decision-Scale Use in Tool-Augmented LLMs: A Contrastive Urban Benchmark](https://arxiv.org/abs/2609.16607)
...
### [90] [AURA: Agentic Diagnosis and Refinement for Production Recommender Systems at Scale](https://arxiv.org/abs/2609.16625)
...
### [91] [Efficient Swing Computation for Retrieval in Large-Scale Recommender Systems](https://arxiv.org/abs/2609.16850)
...
### [92] [Moral Missions: Surfacing Moral Decision-Making Strategies for Responsible Data Science Practice](https://arxiv.org/abs/2609.16166)
...
### [93] [When AI Says "I Am Unable to Answer": Understanding User Responses to AI Refusals](https://arxiv.org/abs/2609.16191)
...
### [94] [SuperSenseDoctor: A Multimodal and Contactless Agent for Health Tracking](https://arxiv.org/abs/2609.16257)
...
### [95] [Intelligent Interaction Techniques (IIxT) - Proposal](https://arxiv.org/abs/2609.16295)
*Brad A. Myers*
...
### [96] [From Momentary Emotion Inference to Sustained Emotion Support: Evaluating a Companion Agent in a Longitudinal Study](https://arxiv.org/abs/2609.16344)
...
### [97] [When a Story Feels Like Mine: How Personalized Narratives and Humor Shape Older Adults' Empathy toward LLM-Generated Peer Health Stories](https://arxiv.org/abs/2609.16374)
...
### [98] [Context-Aware Emotionally Adaptive Voice Assistants: A Multimodal Framework for Empathetic Human-Agent Interaction](https://arxiv.org/abs/2609.16417)
...
### [99] [The Evolution of Coordination in a Collective Intelligence System: 25 Years of English Wikipedia and the Emergence of Generative AI](https://arxiv.org/abs/2609.16856)
...
### [100] [A light-touch AI literacy intervention helps protect against AI political persuasion](https://arxiv.org/abs/2609.16432)
...
### [101] ["ChatGPT, what am I missing?": Designing AI Workflows around Professional Task Structure to Shape Analytic AI Use](https://arxiv.org/abs/2609.16482)
...
### [102] [Beyond Gestures: Estimating Full Hand Pose and Contact Forces from Wrist-Worn Pressure Sensor Array](https://arxiv.org/abs/2609.16518)
...
### [103] [Ptolemy: A Semantic Map of Exploratory Data Analysis](https://arxiv.org/abs/2609.16539)
...
### [104] [Lexplorer: Navigating the Complexity of Legal Document Landscapes](https://arxiv.org/abs/2609.17366)
...
### [105] [EmoPhone: A Multi-Wave Dataset for In-the-Wild Mobile and Wearable Affect Sensing](https://arxiv.org/abs/2609.16581)
...
### [106] [CATVis: A Collaborative Multi-Agent Workflow for Turbomachinery Simulation Data Visualization](https://arxiv.org/abs/2609.16598)
...
### [107] [Beyond Benefit or Risk: Perceived Impact Profiles of Human-AI Affective Interaction and Their Associations with Psychological Functioning](https://arxiv.org/abs/2609.16645)
...
### [108] [NephoCodex: Exploring Bounded Material Agency in Weather Data Physicalization](https://arxiv.org/abs/2609.16687)
...
### [109] [EgoAsk: Egocentric Teaching of Personalized Object Knowledge for Household Robots](https://arxiv.org/abs/2609.16766)
...
### [110] [Available but Unclaimed: An Empirical Study of Human-AI Synergy](https://arxiv.org/abs/2609.16793)
...
### [111] [Disrupted Companionship: A Risk Assessment Framework and Cross-Platform Quantitative Analysis of Psychosocial Responses to AI Companion Disruptions](https://arxiv.org/abs/2609.16907)
...
### [112] [Beyond "ChatGPT Can Make Mistakes": Designing Interventions to Support Metacognitive Monitoring in AI-Assisted Work](https://arxiv.org/abs/2609.17065)
...
### [113] [Enhancing Procedural Writing Through Personalized Example Retrieval: A Case Study on Cooking Recipes](https://arxiv.org/abs/2609.17118)
...
### [114] [A Scenario-Knowledge-Driven Pipeline for Just-in-Time Assistance](https://arxiv.org/abs/2609.17132)
...
### [115] [[MM/AI] Mental Models in Human-AI Interaction: Methods and Challenges in the Generative and Agentic AI Era (Workshop)](https://arxiv.org/abs/2609.17206)
...
### [116] ["Piecing Data Connections Together Like a Puzzle": Effects of Increasing Task Complexity on the Effectiveness of Data Storytelling Enhanced Visualisations](https://arxiv.org/abs/2609.17278)
...
### [117] [When AI Becomes Hard to Understand: Cognitive Demands in Real-World Human-AI Conversations](https://arxiv.org/abs/2609.17301)
...
### [118] [LumiNote: LLM-Assisted Multimodal Instruction for VR Stage Lighting Education](https://arxiv.org/abs/2609.17335)
...
### [119] [CareMirror: Bringing Caregiver Wellbeing into the Dementia Care Ecosystem](https://arxiv.org/abs/2609.17434)
...
### [120] [How Does Title Framing Influence Pattern Identification in Line Charts?](https://arxiv.org/abs/2609.17455)
...
### [121] [Quick-View Takeaways: How Does Title Framing Influences Pattern Identification in Line Charts?](https://arxiv.org/abs/2609.17485)
