...
### [1] [Concurrent Streaming, Viewer Transfers, and Audience Loyalty in a Creator Ecosystem: A Minute-Level Longitudinal Study](https://arxiv.org/abs/2603.23773)
*Maxwell Shepherd*
...
### [2] [Human, AI, and Hybrid Ensembles for Detection of Adaptive, RL-based Social Bots](https://arxiv.org/abs/2603.23796)
...
### [3] [ProcureGym: A Multi-Agent Markov Game Framework for Modeling National Volume-based Drug Procurement](https://arxiv.org/abs/2603.23880)
...
### [4] [Supporting Music Education through Visualizations of MIDI Recordings](https://arxiv.org/abs/2603.23631)
...
### [5] [Augmented Reality Visualization for Musical Instrument Learning](https://arxiv.org/abs/2603.23639)
*Frank Heyen,Michael Sedlmair*
...
### [6] [Assessment Design in the AI Era: A Method for Identifying Items Functioning Differentially for Humans and Chatbots](https://arxiv.org/abs/2603.23682)
...
### [7] [Exploring Self-Tracking Practices of Older Adults with CVD to Inform the Design of LLM-Enabled Health Data Sensemaking](https://arxiv.org/abs/2603.23733)
...
### [8] [AI Fortune-Teller: Juxtaposing Shaman and AI to Reveal Human Agency in the Age of AI](https://arxiv.org/abs/2603.23811)
...
### [9] [A Reproducible Reality-to-VR Pipeline for Ecologically Valid Aging-in-Place Research](https://arxiv.org/abs/2603.23812)
...
### [10] [Aesthetics of Robot-Mediated Applied Drama: A Case Study on REMind](https://arxiv.org/abs/2603.23816)
...
### [11] [CodeExemplar: Example-Based Scaffolding for Introductory Programming in the GenAI Era](https://arxiv.org/abs/2603.23830)
...
### [12] [General Intellectual Humility Is Malleable Through AI-Mediated Reflective Dialogue](https://arxiv.org/abs/2603.23855)
...
### [13] [Skewed Dual Normal Distribution Model: Predicting Touch Pointing Success Rates for Targets Near Screen Edges and Corners](https://arxiv.org/abs/2603.23865)
...
### [14] [Human Factors in Detecting AI-Generated Portraits: Age, Sex, Device, and Confidence](https://arxiv.org/abs/2603.24048)
...
### [15] [Honey, I shrunk the scientist -- Evaluating 2D, 3D, and VR interfaces for navigating samples under the microscope](https://arxiv.org/abs/2603.24337)
...
### [16] [A Neuro-Symbolic System for Interpretable Multimodal Physiological Signals Integration in Human Fatigue Detection](https://arxiv.org/abs/2603.24358)
...
### [17] [Integrating Causal Machine Learning into Clinical Decision Support Systems: Insights from Literature and Practice](https://arxiv.org/abs/2603.24448)
...
### [18] [Vibe Coding XR: Accelerating AI + XR Prototyping with XR Blocks and Gemini](https://arxiv.org/abs/2603.24591)
...
### [20] [VILLA: Versatile Information Retrieval From Scientific Literature Using Large LAnguage Models](https://arxiv.org/abs/2603.23849)
...
### [21] [S4CMDR: a metadata repository for electronic health records](https://arxiv.org/abs/2603.24118)
...
### [22] [Sequence-aware Large Language Models for Explainable Recommendation](https://arxiv.org/abs/2603.24136)
...
### [23] [SumRank: Aligning Summarization Models for Long-Document Listwise Reranking](https://arxiv.org/abs/2603.24204)
...
### [24] [Who Benefits from RAG? The Role of Exposure, Utility and Attribution Bias](https://arxiv.org/abs/2603.24218)
...
### [25] [UniScale: Synergistic Entire Space Data and Model Scaling for Search Ranking](https://arxiv.org/abs/2603.24226)
...
### [26] [Exploring How Fair Model Representations Relate to Fair Recommendations](https://arxiv.org/abs/2603.24396)
...
### [27] [OneSearch-V2: The Latent Reasoning Enhanced Self-distillation Generative Search Framework](https://arxiv.org/abs/2603.24422)
...
### [28] [Evaluating Chunking Strategies For Retrieval-Augmented Generation in Oil and Gas Enterprise Documents](https://arxiv.org/abs/2603.24556)
...
### [29] [PLDR-LLMs Reason At Self-Organized Criticality](https://arxiv.org/abs/2603.23539)
*Burc Gokden*
...
### [30] [Environment Maps: Structured Environmental Representations for Long-Horizon Agents](https://arxiv.org/abs/2603.23610)
...
### [31] [Evaluating a Multi-Agent Voice-Enabled Smart Speaker for Care Homes: A Safety-Focused Framework](https://arxiv.org/abs/2603.23625)
...
### [33] [Can LLM Agents Be CFOs? A Benchmark for Resource Allocation in Dynamic Enterprise Environments](https://arxiv.org/abs/2603.23638)
...
### [34] [GTO Wizard Benchmark](https://arxiv.org/abs/2603.23660)
...
### [35] [Grounding Vision and Language to 3D Masks for Long-Horizon Box Rearrangement](https://arxiv.org/abs/2603.23676)
...
### [36] [LLMs Do Not Grade Essays Like Humans](https://arxiv.org/abs/2603.23714)
...
### [37] [Efficient Benchmarking of AI Agents](https://arxiv.org/abs/2603.23749)
*Franck Ndzomga*
...
### [38] [Learning-guided Prioritized Planning for Lifelong Multi-Agent Path Finding in Warehouse Automation](https://arxiv.org/abs/2603.23838)
...
### [39] [VehicleMemBench: An Executable Benchmark for Multi-User Long-Term Memory in In-Vehicle Agents](https://arxiv.org/abs/2603.23840)
...
### [40] [SCoOP: Semantic Consistent Opinion Pooling for Uncertainty Quantification in Multiple Vision-Language Model Systems](https://arxiv.org/abs/2603.23853)
...
### [41] [The DeepXube Software Package for Solving Pathfinding Problems with Learned Heuristic Functions and Search](https://arxiv.org/abs/2603.23873)
*Forest Agostinelli*
...
### [42] [DUPLEX: Agentic Dual-System Planning via LLM-Driven Information Extraction](https://arxiv.org/abs/2603.23909)
...
### [43] [AnalogAgent: Self-Improving Analog Circuit Design Automation with LLM Agents](https://arxiv.org/abs/2603.23910)
...
### [44] [From Pixels to Digital Agents: An Empirical Study on the Taxonomy and Technological Trends of Reinforcement Learning Environments](https://arxiv.org/abs/2603.23964)
...
### [45] [Language-Grounded Multi-Agent Planning for Personalized and Fair Participatory Urban Sensing](https://arxiv.org/abs/2603.24014)
...
### [46] [ELITE: Experiential Learning and Intent-Aware Transfer for Self-improving Embodied Agents](https://arxiv.org/abs/2603.24018)
...
### [47] [Enhanced Mycelium of Thought (EMoT): A Bio-Inspired Hierarchical Reasoning Architecture with Strategic Dormancy and Mnemonic Encoding](https://arxiv.org/abs/2603.24065)
*Florian Odi Stummer*
...
### [48] [Bridging the Evaluation Gap: Standardized Benchmarks for Multi-Objective Search](https://arxiv.org/abs/2603.24084)
...
### [49] [AI-Supervisor: Autonomous AI Research Supervision via a Persistent Research World Model](https://arxiv.org/abs/2603.24402)
*Yunbo Long*
...
### [50] [From Liar Paradox to Incongruent Sets: A Normal Form for Self-Reference](https://arxiv.org/abs/2603.24527)
...
### [51] [Completeness of Unbounded Best-First Minimax and Descent Minimax](https://arxiv.org/abs/2603.24572)
*Quentin Cohen-Solal*
...
### [52] [The Stochastic Gap: A Markovian Framework for Pre-Deployment Reliability and Oversight-Cost Auditing in Agentic Artificial Intelligence](https://arxiv.org/abs/2603.24582)
