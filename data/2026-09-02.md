...
### [21] [Socrates went Nuclear: Comparing Interaction Strategies for AI systems in a Learning Context using Brain Sensing](https://arxiv.org/abs/2609.00584)
...
### [36] [RestoreBench: Can AI Agents Restore Power Flow Convergence?](https://arxiv.org/abs/2609.00384)
...
### [37] [Dependency-Aware Chain-of-Thought Compression for Financial Reasoning](https://arxiv.org/abs/2609.00413)
...
### [38] [SpecMind: Enabling Spectrum Intelligence via Multi-Agent Hybrid Retrieval-Augmented Generation](https://arxiv.org/abs/2609.00427)
...
### [39] [SAGE: State-Grounded, Abstention-Aware Evaluation of Task-Oriented Dialogue Agents](https://arxiv.org/abs/2609.00434)
...
### [125] [Collaboratively Eliciting Gestures for Geospatial Data Exploration on an MSE with Tangibles and Styluses](https://arxiv.org/abs/2609.00007)
...
### [126] [Cyber-Physical Digital Factory Architecture as the Enabler of Disembodied Work](https://arxiv.org/abs/2609.00195)
...
### [127] [AniMaster: From Story Texts to Animated Videos via Cinematic Script Generation and Interactive Authoring](https://arxiv.org/abs/2609.00346)
...
### [128] [MorphPatch: Enhancing VR Interaction on Shape Displays using Surface Approximation and Visuo-Haptic Illusions](https://arxiv.org/abs/2609.00371)
...
### [129] [FocusBuddy: Encouraging Healthy Desk-Work Habits by Caring for a Virtual Pet on a Water Bottle](https://arxiv.org/abs/2609.00412)
...
### [130] [ErgoAssist: Cognition-Aware Posture Feedback in Wearable Ergonomic Systems](https://arxiv.org/abs/2609.00440)
...
### [131] [Design principles to Increase Technology Self-efficacy for Older Australians with Mild Cognitive Impairment (MCI) and Older Carers](https://arxiv.org/abs/2609.00480)
...
### [132] [UniScale: Exploring Unimanual Gesture Mapping Strategies for Gaze+Pinch-based Scaling Interaction](https://arxiv.org/abs/2609.00500)
...
### [133] [RecalibrateGPT: AI Fatigue Resilient Conversational Interfaces](https://arxiv.org/abs/2609.00506)
*Nikhil Wani*
...
### [134] [Are We There Yet? Assessing Computer-Use Agents for Blind Users' Accessible Interaction with Desktop Applications](https://arxiv.org/abs/2609.00524)
...
### [135] [Learning Feasibility-Aware Latent Spaces for Preference-Based Exploration of Procedural Automotive Wheel Designs](https://arxiv.org/abs/2609.00527)
...
### [136] [Ctrl-F-Resist. Practices, Challenges, and Technical Needs of Civil Society Organizations Monitoring the Far-Right Online](https://arxiv.org/abs/2609.00808)
...
### [137] [GazeTune: Facilitating Precise Gaze-Driven Interactions with Cascaded Touch Input](https://arxiv.org/abs/2609.00716)
...
### [138] [No Pixel Left Behind: Filling Gaps in Anime Colorization](https://arxiv.org/abs/2609.00800)
...
### [139] [Beyond Technological Solutionism: Rethinking XR in Healthcare](https://arxiv.org/abs/2609.01028)
...
### [140] [Cross-Modal Guidance for Out-of-View Object Search in Simulated Prosthetic Vision](https://arxiv.org/abs/2609.01438)
...
### [141] [Better Situational Awareness in AR-HRC? A Comparative Study of Augmented Reality and Mobile Interfaces for Human-Robot Collaboration](https://arxiv.org/abs/2609.01461)
...
### [142] [Evaluating Usability in Biomedical Visualization: Rethinking Heuristic Evaluation for Spatial Omics and Multidisciplinary Research Platforms](https://arxiv.org/abs/2609.01569)
...
### [143] [Designing Proactive Thought Partners for Writing](https://arxiv.org/abs/2609.01588)
...
### [144] [Core-periphery identification in massive networks](https://arxiv.org/abs/2609.00008)
*Eric Yanchenko*
...
### [145] [Centrality Measures in Temporal Networks: A Critical and Comparative Survey](https://arxiv.org/abs/2609.00011)
...
### [146] [Social bots weaken activist cohesion](https://arxiv.org/abs/2609.00197)
...
### [147] [Aligned but Flattened: Analyzing the Trade-off between Cultural Alignment and Diversity in LLMs](https://arxiv.org/abs/2609.00565)
...
### [148] [Agent-Enhanced Heterogeneous Graph RAG for Academic Question Answering](https://arxiv.org/abs/2609.00761)
...
### [149] [A Network Science Perspective on Evaluating Deep Graph Generative Models](https://arxiv.org/abs/2609.01015)
...
### [150] [Don't You Know, Pump it Up! Investigating Cryptocurrency Manipulation in Telegram-Driven Activity](https://arxiv.org/abs/2609.01176)
...
### [151] [SilentProbe: Measuring Silent Failure in Production APIs Used as Agent Tools](https://arxiv.org/abs/2609.00035)
...
### [152] [Two-Sided State-Space Models for Sequential Recommendation with Non-Random Multimodal Review Feedback](https://arxiv.org/abs/2609.00165)
...
### [153] [MUSES: A Benchmark for Prospective Intellectual-Roots Retrieval](https://arxiv.org/abs/2609.00313)
...
### [154] [Closed Forms and Synthetic Twins: Predicting Approximate Nearest Neighbor Recall from Embedding Statistics](https://arxiv.org/abs/2609.00364)
*Shmuel Herman*
...
### [155] [Towards Effective Structured Context Modeling for Conversational Recommender Systems via Dual-node Monte Carlo Tree Search](https://arxiv.org/abs/2609.00618)
...
### [156] [It Takes Two to Match: Co-Evolving Generative Retriever with Reinforcement Learning](https://arxiv.org/abs/2609.00638)
...
### [157] [From Saliency to Discriminability: Rank-Preserving Visual Token Pruning for VLM Rerankers](https://arxiv.org/abs/2609.00667)
...
### [158] [SwapRec: Warming Up Cold Items Through Training-Time Swaps](https://arxiv.org/abs/2609.00913)
...
### [159] [TGR: Advancing Industrial Recommendation from Generative-Paradigm Ranking toward Unified Generation and Reasoning](https://arxiv.org/abs/2609.00986)
...
### [160] [Web Price Extraction: State of the Art and an Adaptive Browserless Implementation](https://arxiv.org/abs/2609.01030)
...
### [161] [World Model-Guided Reinforcement Learning via Counterfactual User Engagement Simulation](https://arxiv.org/abs/2609.01067)
...
### [162] [From Language to Behavior: Scaling Sequence Transformers for Industrial Recommendation Ranking with Rec-Native Designs](https://arxiv.org/abs/2609.01240)
...
### [164] [AutoConcept: Training-Free Concept-Guided Reranking for Metadata-Available Composed Image Retrieval](https://arxiv.org/abs/2609.01456)
