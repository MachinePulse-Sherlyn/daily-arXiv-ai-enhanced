...
### [16] [SocialCoach: Personalized Social Skill Learning with RL-based Agentic Tutoring and Practice](https://arxiv.org/abs/2606.04155)
...
### [17] [Creative Reading: Scaffolding Reading for Transformation](https://arxiv.org/abs/2606.04308)
...
### [18] [When Chatbots Accommodate: What AI Companions Optimize for in Vulnerable Conversations](https://arxiv.org/abs/2606.04431)
...
### [19] [Speculating the Impacts of Mediated Social Touch Technology](https://arxiv.org/abs/2606.04489)
...
### [20] [Addressing Negative Commons Governance with Positive Commons Principles](https://arxiv.org/abs/2606.04563)
...
### [21] [CapSenseBand: Sustaining Cross-Disciplinary Creativity When Stitches Must Meet Signals](https://arxiv.org/abs/2606.04609)
...
### [22] [Clinical Assistant for Remote Engagement Link (CARE-link): A Web-Based Electronic Health Records Software for Managing Diabetes](https://arxiv.org/abs/2606.04952)
...
### [23] [What Can Eye Gaze Teach Us About Real-World Cycling? Insights From the Oxford RobotCycle Project](https://arxiv.org/abs/2606.04989)
...
### [24] [PhysDox: Benchmarking LLMs on Physical Feasibility Auditing of Physiological Sensing Protocols](https://arxiv.org/abs/2606.05003)
...
### [25] [Scaling Expert Feedback with Reflective Edit Propagation in Compositional Knowledge Bases](https://arxiv.org/abs/2606.05023)
...
### [26] ["A Glimpse, Not a Gaze": Using Generative AI to Balance Privacy and Awareness in Inter-generational Caregiving](https://arxiv.org/abs/2606.05055)
...
### [27] [Network node immunization: improving Netshield algorithm through random rooted forests](https://arxiv.org/abs/2606.04131)
...
### [28] [Structural properties of the implicit function defined by an integral self-consistency equation](https://arxiv.org/abs/2606.04243)
*Ivan Viakhirev*
...
### [29] [What Makes Majority Illusion Easy to Detect?](https://arxiv.org/abs/2606.04260)
...
### [30] [Characterizing Online Criticism of Partisan News Media Using Weakly Supervised Learning](https://arxiv.org/abs/2606.04289)
...
### [31] [Forecasting Political News Engagement on Social Media](https://arxiv.org/abs/2606.04293)
*Karthik Shivaram,Mustafa Bilgic,Matthew Shapiro,Aron Culotta*
...
### [32] [Modeling and Interpreting Teamwork Dynamics in Cancer Care Outcome Prediction](https://arxiv.org/abs/2606.04499)
...
### [33] [Federating Governance: How Community Rules Scale with Mastodon Instances](https://arxiv.org/abs/2606.05069)
...
### [34] [Toward Pre-Deployment Assurance for Enterprise AI Agents: Ontology-Grounded Simulation and Trust Certification](https://arxiv.org/abs/2606.04037)
...
### [35] [Stumbling Into AI Emotional Dependence: How Routine AI Interactions Reshape Human Connection](https://arxiv.org/abs/2606.04150)
...
### [36] [Thinking Through Signs: PEEL as a Semiotic Scaffolding for Epistemically Accountable AI-Enabled Research](https://arxiv.org/abs/2606.04152)
...
### [37] [SMAC-Talk: A Natural Language Extension of the StarCraft Multi-Agent Challenge for Large Language Models](https://arxiv.org/abs/2606.04202)
...
### [38] [Consensus is Strategically Insufficient: Reasoning-Trace Disagreement as a Knowledge-Representation Signal](https://arxiv.org/abs/2606.04223)
...
### [39] [VAMPS: Visual-Assisted Mathematical Problem Solving Benchmark](https://arxiv.org/abs/2606.04244)
...
### [42] [Neetyabhas: A Framework for Uncertainty-Aware Public Policy Optimization in Rational Agent-Based Models](https://arxiv.org/abs/2606.04562)
...
### [46] [The Digital Apprentice: A Framework for Human-Directed Agentic AI Development](https://arxiv.org/abs/2606.04321)
...
### [47] [Online Skill Learning for Web Agents via State-Grounded Dynamic Retrieval](https://arxiv.org/abs/2606.04391)
...
### [48] [Cascading Hallucination in Agentic RAG: The CHARM Framework for Detection and Mitigation](https://arxiv.org/abs/2606.04435)
*Saroj Mishra*
...
### [49] [Not All Errors Are Equal: Consequence-Aware Reasoning Compute Allocation](https://arxiv.org/abs/2606.04402)
...
### [50] [Trivium: Temporal Regret as a First-Class Objective for Causal-Memory Controllers](https://arxiv.org/abs/2606.04421)
*Edward Y. Chang*
...
### [51] [The Meta-Agent Challenge: Are Current Agents Capable of Autonomous Agent Development?](https://arxiv.org/abs/2606.04455)
...
### [52] [AgentJet: A Flexible Swarm Training Framework for Agentic Reinforcement Learning](https://arxiv.org/abs/2606.04484)
...
### [53] [Beyond Prompt-Based Planning: MCP-Native Graph Planning-based Biomedical Agent System](https://arxiv.org/abs/2606.04494)
...
### [54] [Simulate, Reason, Decide: Scientific Reasoning with LLMs for Simulation-Driven Decision Making](https://arxiv.org/abs/2606.04505)
...
### [55] [MapAgent: An Industrial-Grade Agentic Framework for City-scale Lane-level Map Generation](https://arxiv.org/abs/2606.04513)
...
### [56] [Scaling Self-Evolving Agents via Parametric Memory](https://arxiv.org/abs/2606.04536)
...
### [57] [SCI-PRM: A Tool Aware Process Reward Model for Scientific Reasoning Verification](https://arxiv.org/abs/2606.04579)
...
### [58] [Learning Admissible Heuristics via Cost Partitioning](https://arxiv.org/abs/2606.04597)
...
### [59] [Plan First, Judge Later, Run Better: A DMAIC-Inspired Agentic System for Industrial Anomaly Detection](https://arxiv.org/abs/2606.04599)
...
### [60] [Parthenon Law: A Self-Evolving Legal-Agent Framework](https://arxiv.org/abs/2606.04602)
*Hejia Geng,Leo Liu*
...
### [61] [A Normative Intermediate Representation for ASP-Based Compliance Reasoning](https://arxiv.org/abs/2606.04619)
...
### [62] [MIRAGE: Mobile Agents with Implicit Reasoning and Generative World Models](https://arxiv.org/abs/2606.04627)
...
### [63] [BiNSGPS: Geometry Problem Solving via Bidirectional Neuro-Symbolic Interaction](https://arxiv.org/abs/2606.04648)
...
### [64] [Fog of Love: Engineering Virtuous Agent Behavior with Affinity-based Reinforcement Learning in a Game Environment](https://arxiv.org/abs/2606.04750)
...
### [65] [FALSIFYBENCH: Evaluating Inductive Reasoning in LLMs with Rule Discovery Games](https://arxiv.org/abs/2606.04751)
...
### [66] [Inference-Time Vulnerability Beyond Shallow Safety: Alignment Along Generation Trajectories](https://arxiv.org/abs/2606.04778)
...
### [68] [AIP: A Graph Representation for Learning and Governing Agent Skills](https://arxiv.org/abs/2606.04781)
...
### [69] [BiasGRPO: Stabilizing Bias Mitigation in High-Variance Reward Landscapes via Group-Relative Policy Optimization](https://arxiv.org/abs/2606.04807)
...
### [70] [Beyond Objective Equivalence: Constraint Injection for LLM-Based Optimization Modeling on Vehicle Routing Problems](https://arxiv.org/abs/2606.04816)
...
### [71] [R-APS: Compositional Reasoning and In-Context Meta-Learning for Constrained Design via Reflective Adversarial Pareto Search](https://arxiv.org/abs/2606.04823)
...
### [72] [AICompanionBench: Benchmarking LLMs-as-Judges for AI Companion Safety](https://arxiv.org/abs/2606.04867)
...
### [73] [What Type of Inference is Active Inference?](https://arxiv.org/abs/2606.04935)
...
### [74] [AutoLab: Can Frontier Models Solve Long-Horizon Auto Research and Engineering Tasks?](https://arxiv.org/abs/2606.05080)
...
### [75] [Knowledge Index of Noah's Ark](https://arxiv.org/abs/2606.05104)
