...
### [12] [Operating-Layer Controls for Onchain Language-Model Agents Under Real Capital](https://arxiv.org/abs/2604.26091)
...
### [13] [Distill-Belief: Closed-Loop Inverse Source Localization and Characterization in Physical Fields](https://arxiv.org/abs/2604.26095)
...
### [14] [Hierarchical Multi-Persona Induction from User Behavioral Logs: Learning Evidence-Grounded and Truthful Personas](https://arxiv.org/abs/2604.26120)
...
### [15] [OMEGA: Optimizing Machine Learning by Evaluating Generated Algorithms](https://arxiv.org/abs/2604.26211)
...
### [16] [Persuadability and LLMs as Legal Decision Tools](https://arxiv.org/abs/2604.26233)
...
### [17] [Apriori-based Analysis of Learned Helplessness in Mathematics Tutoring: Behavioral Patterns by Level, Intervention, and Outcome](https://arxiv.org/abs/2604.26237)
*John Paul P. Miranda*
...
### [18] [DreamProver: Evolving Transferable Lemma Libraries via a Wake-Sleep Theorem-Proving Agent](https://arxiv.org/abs/2604.26311)
...
### [19] [Auto-Relational Reasoning](https://arxiv.org/abs/2604.26507)
...
### [20] [Grounding vs. Compositionality: On the Non-Complementarity of Reasoning in Neuro-Symbolic Systems](https://arxiv.org/abs/2604.26521)
...
### [22] [Benchmarking the Safety of Large Language Models for Robotic Health Attendant Control](https://arxiv.org/abs/2604.26577)
...
### [23] [Human-in-the-Loop Benchmarking of Heterogeneous LLMs for Automated Competency Assessment in Secondary Level Mathematics](https://arxiv.org/abs/2604.26607)
...
### [24] [When to Vote, When to Rewrite: Disagreement-Guided Strategy Routing for Test-Time Scaling](https://arxiv.org/abs/2604.26644)
...
### [25] [SciHorizon-DataEVA: An Agentic System for AI-Readiness Evaluation of Heterogeneous Scientific Data](https://arxiv.org/abs/2604.26645)
...
### [26] [FutureWorld: A Live Environment for Training Predictive Agents with Real-World Outcome Rewards](https://arxiv.org/abs/2604.26733)
...
### [27] [Bian Que: An Agentic Framework with Flexible Skill Arrangement for Online System Operations](https://arxiv.org/abs/2604.26805)
...
### [28] [Designing Rewards for Rewarding Designs: Demonstrating the Impact of Rewards on the Creative Design Process](https://arxiv.org/abs/2604.26083)
...
### [30] [Ceci n'est pas une explication: Evaluating Explanation Failures as Explainability Pitfalls in Language Learning Systems](https://arxiv.org/abs/2604.26145)
...
### [31] [Beyond Screenshots: Evaluating VLMs' Understanding of UI Animations](https://arxiv.org/abs/2604.26148)
...
### [32] [Exploring the Feasibility and Acceptability of AI-Mediated Serious Illness Conversations in the Emergency Department](https://arxiv.org/abs/2604.26214)
...
### [33] [Towards Low-Cost Low-Power Activity-Aware Soil Moisture Sensing Platform for Large-scale Farming](https://arxiv.org/abs/2604.26303)
...
### [34] [Towards a Frugal Photosynthesis Sensing Toolkit for Data-Driven Plant Science Education and Exploration](https://arxiv.org/abs/2604.26305)
...
### [35] [UIGaze: How Closely Can VLMs Approximate Human Visual Attention on User Interfaces?](https://arxiv.org/abs/2604.26352)
...
### [36] [Culturally Aware GenAI Risks for Youth: Perspectives from Youth, Parents, and Teachers in a Non-Western Context](https://arxiv.org/abs/2604.26494)
...
### [37] [Persona-Based Process Design for Assistive Human-Robot Workplaces for Persons with Disabilities](https://arxiv.org/abs/2604.26527)
...
### [38] [MultEval: Supporting Collaborative Alignment for LLM-as-a-Judge Evaluation Criteria](https://arxiv.org/abs/2604.26679)
...
### [39] [Transferability of Token Usage Rights: A Design Space Analysis of Generative AI Services](https://arxiv.org/abs/2604.26683)
...
### [40] [Artistic Practice Opportunities in CST Evaluations: A Longitudinal Group Deployment of ArtKrit](https://arxiv.org/abs/2604.26935)
...
### [41] [Institutional Floors and Partisan Lenses: Cross-National Online Discourse on Political Violence in France and the United States](https://arxiv.org/abs/2604.26245)
*Andrew Yen Chang*
...
### [42] [Impact of Attitude and Bounded Rationality on Collective Behavioral Transitions](https://arxiv.org/abs/2604.26616)
