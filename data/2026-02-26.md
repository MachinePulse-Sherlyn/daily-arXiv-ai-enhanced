...
### [6] [Heads Up!: Towards In Situ Photogrammetry Annotations and Augmented Reality Visualizations for Guided Backcountry Skiing](https://arxiv.org/abs/2602.21771)
...
### [7] [StylusPort: Investigating Teleportation using Stylus in VR](https://arxiv.org/abs/2602.21799)
...
### [8] [Interactive Augmented Reality-enabled Outdoor Scene Visualization For Enhanced Real-time Disaster Response](https://arxiv.org/abs/2602.21874)
...
### [9] [A Critical Reflection on the Values and Assumptions in Data Visualization](https://arxiv.org/abs/2602.22051)
...
### [10] [ViSTAR: Virtual Skill Training with Augmented Reality with 3D Avatars and LLM coaching agent](https://arxiv.org/abs/2602.22077)
...
### [11] [SocialPulse: On-Device Detection of Social Interactions in Naturalistic Settings Using Smartwatch Multimodal Sensing](https://arxiv.org/abs/2602.22085)
...
### [12] [Giving Meaning to Movements: Challenges and Opportunities in Expanding Communication by Pairing Unaided AAC with Speech Generated Messages](https://arxiv.org/abs/2602.22131)
...
### [13] [Speculating for Epiplexity: How to Learn the Most from Speculative Design?](https://arxiv.org/abs/2602.22132)
*Botao Amber Hu*
...
### [14] [When AI Writes, Whose Voice Remains? Quantifying Cultural Marker Erasure Across World English Varieties in Large Language Models](https://arxiv.org/abs/2602.22145)
...
### [15] [A Taxonomy of Human--MLLM Interaction in Early-Stage Sketch-Based Design Ideation](https://arxiv.org/abs/2602.22171)
...
### [16] [Codesigning Ripplet: an LLM-Assisted Assessment Authoring System Grounded in a Conceptual Model of Teachers' Workflows](https://arxiv.org/abs/2602.22186)
...
### [17] [Revisiting Text Ranking in Deep Research](https://arxiv.org/abs/2602.21456)
...
### [18] [Revisiting RAG Retrievers: An Information Theoretic Benchmark](https://arxiv.org/abs/2602.21553)
...
### [19] [Retrieval Challenges in Low-Resource Public Service Information: A Case Study on Food Pantry Access](https://arxiv.org/abs/2602.21598)
...
### [20] [AQR-HNSW: Accelerating Approximate Nearest Neighbor Search via Density-aware Quantization and Multi-stage Re-ranking](https://arxiv.org/abs/2602.21600)
...
### [21] [Trie-Aware Transformers for Generative Recommendation](https://arxiv.org/abs/2602.21677)
...
### [22] [Offline Reasoning for Efficient Recommendation: LLM-Empowered Persona-Profiled Item Indexing](https://arxiv.org/abs/2602.21756)
...
### [23] [Learning to Collaborate via Structures: Cluster-Guided Item Alignment for Federated Recommendation](https://arxiv.org/abs/2602.21957)
...
### [24] [The Language of Infographics: Toward Understanding Conceptual Metaphor Use in Scientific Storytelling](https://arxiv.org/abs/2407.13416)
...
### [25] [A Dynamic Survey of Soft Set Theory and Its Extensions](https://arxiv.org/abs/2602.21268)
...
### [26] [A Hierarchical Multi-Agent System for Autonomous Discovery in Geoscientific Data Archives](https://arxiv.org/abs/2602.21351)
...
### [27] [Beyond Refusal: Probing the Limits of Agentic Self-Correction for Semantic Sensitive Information](https://arxiv.org/abs/2602.21496)
...
### [28] [ARLArena: A Unified Framework for Stable Agentic Reinforcement Learning](https://arxiv.org/abs/2602.21534)
...
### [29] [Power and Limitations of Aggregation in Compound AI Systems](https://arxiv.org/abs/2602.21556)
...
### [30] [The ASIR Courage Model: A Phase-Dynamic Framework for Truth Transitions in Human and AI Systems](https://arxiv.org/abs/2602.21745)
*Hyo Jin Kim*
...
### [31] [fEDM+: A Risk-Based Fuzzy Ethical Decision Making Framework with Principle-Level Explainability and Pluralistic Validation](https://arxiv.org/abs/2602.21746)
...
### [32] [Prompt Architecture Determines Reasoning Quality: A Variable Isolation Study on the Car Wash Problem](https://arxiv.org/abs/2602.21814)
*Heejin Jo*
...
### [33] [Distill and Align Decomposition for Enhanced Claim Verification](https://arxiv.org/abs/2602.21857)
...
### [34] [ProactiveMobile: A Comprehensive Benchmark for Boosting Proactive Intelligence on Mobile Devices](https://arxiv.org/abs/2602.21858)
...
### [35] [2-Step Agent: A Framework for the Interaction of a Decision Maker with AI Decision Support](https://arxiv.org/abs/2602.21889)
...
### [36] [Semantic Partial Grounding via LLMs](https://arxiv.org/abs/2602.22067)
...
### [37] [Language Models Exhibit Inconsistent Biases Towards Algorithmic Agents and Human Experts](https://arxiv.org/abs/2602.22070)
...
### [38] [Petri Net Relaxation for Infeasibility Explanation and Sequential Task Planning](https://arxiv.org/abs/2602.22094)
...
### [39] [Toward Effective Multi-Domain Rumor Detection in Social Networks Using Domain-Gated Mixture-of-Experts](https://arxiv.org/abs/2602.21214)
...
### [40] [@GrokSet: multi-party Human-LLM Interactions in Social Media](https://arxiv.org/abs/2602.21236)
...
### [41] [RABot: Reinforcement-Guided Graph Augmentation for Imbalanced and Noisy Social Bot Detection](https://arxiv.org/abs/2602.21749)
...
### [42] [Embedding-aware Polarization Management in Signed Networks](https://arxiv.org/abs/2602.21755)
...
### [43] [Bridging Through Absence: How Comeback Researchers Bridge Knowledge Gaps Through Structural Re-emergence](https://arxiv.org/abs/2602.21926)
