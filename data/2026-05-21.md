...
### [22] [Prism: Structural Symmetry Scanning via Duality-Constrained Laplacian Projection](https://arxiv.org/abs/2605.20245)
*Jiatong Xie*
...
### [23] [Mapping the Winds of Stance Dynamics using Potential Landscape Models](https://arxiv.org/abs/2605.20363)
...
### [24] [Hiding in Plain Sight: Finding MAHA on Reddit](https://arxiv.org/abs/2605.20435)
...
### [25] [The Structure and Dynamics of the Online MAHA-sphere](https://arxiv.org/abs/2605.20457)
*Sabit Ahmed,Subigya Nepal,Henry Kautz*
...
### [26] [DisImpact: Quantifying the Physi-Social Impact of Natural Disasters Through Social Media](https://arxiv.org/abs/2605.20646)
...
### [27] [DeTox-Fed: Detecting Toxic Conversations in the Fediverse with Federated Graph Neural Networks](https://arxiv.org/abs/2605.21054)
...
### [28] [SURGE: An Event-Centric Social Media Sentiment Time Series Benchmark with Interaction Structure](https://arxiv.org/abs/2605.21198)
...
### [29] [ECHO-PPI: Trustworthy AI for Evidence-Bundled Detection of Overlapping Protein Modules in Protein-Protein Interaction Networks](https://arxiv.org/abs/2605.21216)
...
### [30] [ASIND: Alternating Sparse Identification for Predicting Network Dynamics Without Knowledge](https://arxiv.org/abs/2605.21220)
...
### [31] [Efficient Table QA via TableGrid Navigation and Progressive Inference Prompting](https://arxiv.org/abs/2605.20254)
...
### [32] [Layer-wise Token Compression for Efficient Document Reranking](https://arxiv.org/abs/2605.20683)
...
### [33] [CALMem : Application-Layer Dual Memory for Conversational AI](https://arxiv.org/abs/2605.20724)
...
### [34] [MemConflict: Evaluating Long-Term Memory Systems Under Memory Conflicts](https://arxiv.org/abs/2605.20926)
...
### [35] [SG-LegalCite: A Principle-Augmented Benchmark for Legal Citation Retrieval in Singapore Law](https://arxiv.org/abs/2605.21057)
...
### [37] [OSCToM: RL-Guided Adversarial Generation for High-Order Theory of Mind](https://arxiv.org/abs/2605.20423)
...
### [38] [AgentCo-op: Retrieval-Based Synthesis of Interoperable Multi-Agent Workflows](https://arxiv.org/abs/2605.20425)
...
### [39] [High Quality Embeddings for Horn Logic Reasoning](https://arxiv.org/abs/2605.20467)
...
### [40] [\ECUAS{n}: A family of metrics for principled evaluation of uncertainty-augmented systems](https://arxiv.org/abs/2605.20490)
...
### [41] [Personality Engineering with AI Agents: A New Methodology for Negotiation Research](https://arxiv.org/abs/2605.20554)
...
### [42] [Open-World Evaluations for Measuring Frontier AI Capabilities](https://arxiv.org/abs/2605.20520)
...
### [43] [AgentAtlas: Beyond Outcome Leaderboards for LLM Agents](https://arxiv.org/abs/2605.20530)
...
### [44] [Mahjax: A GPU-Accelerated Mahjong Simulator for Reinforcement Learning in JAX](https://arxiv.org/abs/2605.20577)
...
### [45] [From Automated to Autonomous: Hierarchical Agent-native Network Architecture (HANA)](https://arxiv.org/abs/2605.20608)
...
### [46] [COAgents: Multi-Agent Framework to Learn and Navigate Routing Problems Search Space](https://arxiv.org/abs/2605.20618)
...
### [47] [Evaluating Temporal Semantic Caching and Workflow Optimization in Agentic Plan-Execute Pipelines](https://arxiv.org/abs/2605.20630)
...
### [48] [Declarative Data Services: Structured Agentic Discovery for Composing Data Systems](https://arxiv.org/abs/2605.20690)
*Shanshan Ye,Duo Lu*
...
### [49] [VBFDD-Agent for Electric Vehicle Battery Fault Detection and Diagnosis: Descriptive Text Modeling of Battery Digital Signals](https://arxiv.org/abs/2605.20742)
...
### [50] [Conflict-Aware Additive Guidance for Flow Models under Compositional Rewards](https://arxiv.org/abs/2605.20758)
...
### [51] [Interaction Locality in Hierarchical Recursive Reasoning](https://arxiv.org/abs/2605.20784)
...
### [52] [Conditional Equivalence of DPO and RLHF: Implicit Assumption, Failure Modes, and Provable Alignment](https://arxiv.org/abs/2605.20834)
...
### [53] [PlanningBench: Generating Scalable and Verifiable Planning Data for Evaluating and Training Large Language Models](https://arxiv.org/abs/2605.20873)
...
### [54] [Governance by Construction for Generalist Agents](https://arxiv.org/abs/2605.20874)
...
### [55] [For How Long Should We Be Punching? Learning Action Duration in Fighting Games](https://arxiv.org/abs/2605.20911)
...
### [56] [Playing Devil's Advocate: Off-the-Shelf Persona Vectors Rival Targeted Steering for Sycophancy](https://arxiv.org/abs/2605.21006)
...
### [57] [AutoRPA: Efficient GUI Automation through LLM-Driven Code Synthesis from Interactions](https://arxiv.org/abs/2605.21082)
...
### [58] [ScenePilot: Controllable Boundary-Driven Critical Scenario Generation for Autonomous Driving](https://arxiv.org/abs/2605.21168)
...
### [59] [Insights Generator: Systematic Corpus-Level Trace Diagnostics for LLM Agents](https://arxiv.org/abs/2605.21347)
...
### [60] [Towards Resilient and Autonomous Networks: A BlueSky Vision on AI-Native 6G](https://arxiv.org/abs/2605.21395)
...
### [61] [Teaching AI Through Benchmark Construction: QuestBench as a Course-Based Practice for Accountable Knowledge Work](https://arxiv.org/abs/2605.21413)
...
### [62] [PALS: Power-Aware LLM Serving for Mixture-of-Experts Models](https://arxiv.org/abs/2605.21427)
...
### [63] [Mind the Sim-to-Real Gap & Think Like a Scientist](https://arxiv.org/abs/2605.21458)
...
### [64] [AiraXiv: An AI-Driven Open-Access Platform for Human and AI Scientists](https://arxiv.org/abs/2605.21481)
...
### [65] [DeepWeb-Bench: A Deep Research Benchmark Demanding Massive Cross-Source Evidence and Long-Horizon Derivation](https://arxiv.org/abs/2605.21482)
