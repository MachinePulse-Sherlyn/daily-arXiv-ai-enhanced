...
### [9] [On Emotion-Sensitive Decision Making of Small Language Model Agents](https://arxiv.org/abs/2604.06562)
...
### [10] [Rethinking Generalization in Reasoning SFT: A Conditional Analysis on Optimization, Data, and Model Capability](https://arxiv.org/abs/2604.06628)
...
### [11] [Reasoning Fails Where Step Flow Breaks](https://arxiv.org/abs/2604.06695)
...
### [12] [AgentGate: A Lightweight Structured Routing Engine for the Internet of Agents](https://arxiv.org/abs/2604.06696)
...
### [26] [EviSnap: Faithful Evidence-Cited Explanations for Cold-Start Cross-Domain Recommendation](https://arxiv.org/abs/2604.06172)
...
### [27] [Beyond Case Law: Evaluating Structure-Aware Retrieval and Safety in Statute-Centric Legal QA](https://arxiv.org/abs/2604.06173)
...
### [28] [Robustness Risk of Conversational Retrieval: Identifying and Mitigating Noise Sensitivity in Qwen3-Embedding Model](https://arxiv.org/abs/2604.06176)
...
### [29] [WebExpert: domain-aware web agents with critic-guided expert experience for high-precision search](https://arxiv.org/abs/2604.06177)
...
### [30] [ARIA: Adaptive Retrieval Intelligence Assistant -- A Multimodal RAG Framework for Domain-Specific Engineering Education](https://arxiv.org/abs/2604.06179)
...
### [31] [The Unreasonable Effectiveness of Data for Recommender Systems](https://arxiv.org/abs/2604.06420)
*Youssef Abdou*
...
### [32] [CASE: Cadence-Aware Set Encoding for Large-Scale Next Basket Repurchase Recommendation](https://arxiv.org/abs/2604.06718)
...
### [33] [Leveraging LLMs and Heterogeneous Knowledge Graphs for Persona-Driven Session-Based Recommendation](https://arxiv.org/abs/2604.06928)
...
### [34] [MARVEL: Multimodal Adaptive Reasoning-intensiVe Expand-rerank and retrievaL](https://arxiv.org/abs/2604.07079)
...
### [35] [Leveraging Artist Catalogs for Cold-Start Music Recommendation](https://arxiv.org/abs/2604.07090)
...
### [36] [BRIDGE: Multimodal-to-Text Retrieval via Reinforcement-Learned Query Alignment](https://arxiv.org/abs/2604.07201)
...
### [37] [HIVE: Query, Hypothesize, Verify An LLM Framework for Multimodal Reasoning-Intensive Retrieval](https://arxiv.org/abs/2604.07220)
...
### [38] [IntervenSim: Intervention-Aware Social Network Simulation for Opinion Dynamics](https://arxiv.org/abs/2604.06600)
...
### [39] [Digital Skin, Digital Bias: Uncovering Tone-Based Biases in LLMs and Emoji Embeddings](https://arxiv.org/abs/2604.06863)
...
### [40] [X-BCD: Explainable Sensor-Based Behavioral Change Detection in Smart Home Environments](https://arxiv.org/abs/2604.06174)
...
### [41] [User-Centric Design of UI for Mobile Banking Apps: Improving UI and Features for Better Customer Experience](https://arxiv.org/abs/2604.06175)
...
### [42] ["Help Me, But Don't Watch Me": Intervention Timing and Privacy Boundaries for Process-Aware AI Tutors](https://arxiv.org/abs/2604.06178)
...
### [43] [Digital Weight Management Interventions: A review of commercial solutions and survey analysis of user needs](https://arxiv.org/abs/2604.06181)
...
### [44] [VenusBench-Mobile: A Challenging and User-Centric Benchmark for Mobile GUI Agents with Capability Diagnostics](https://arxiv.org/abs/2604.06182)
...
### [45] [The Impact of Response Latency and Task Type on Human-LLM Interaction and Perception](https://arxiv.org/abs/2604.06183)
...
### [46] [A Goal-Oriented Chatbot for Engaging the Elderly Through Family Photo Conversations](https://arxiv.org/abs/2604.06184)
...
### [47] [Benchmarking LLM Tool-Use in the Wild](https://arxiv.org/abs/2604.06185)
...
### [48] [Full State-Space Visualisation of the 8-Puzzle: Feasibility, Design, and Educational Use](https://arxiv.org/abs/2604.06186)
...
### [49] [Skin-Deep Bias: How Avatar Appearances Shape Perceptions of AI Hiring](https://arxiv.org/abs/2604.06187)
...
### [50] [LLM Spirals of Delusion: A Benchmarking Audit Study of AI Chatbot Interfaces](https://arxiv.org/abs/2604.06188)
...
### [51] [SASLO: A Scene-Aware Spatial Layout Optimization System for AR-SSVEP](https://arxiv.org/abs/2604.06190)
...
### [52] ["It didn't feel right but I needed a job so desperately": Understanding People's Emotions & Help Needs During Financial Scams](https://arxiv.org/abs/2604.06218)
...
### [53] [Navigating Marginalization: Toward Justice-Oriented Socio-Technical Design for Parent-Child Learning among Southeast Asian Immigrant Mothers in Taiwan](https://arxiv.org/abs/2604.06353)
...
### [54] [Intimacy as Service, Harm as Externality: Critical Perspectives on AI Companion Platform Accountability](https://arxiv.org/abs/2604.06381)
...
### [55] [Reproducibility Beyond Artifacts: Interactional Support for Collaborative Machine Learning](https://arxiv.org/abs/2604.06414)
...
### [56] [Trust in AI among Middle Eastern CS Students: Investigating Students' Trust and Usage Patterns Across Saudi Arabia, Kuwait and Jordan](https://arxiv.org/abs/2604.06418)
...
### [57] [Intimate Strangers by Design: A Uses and Gratifications Analysis of AI Companionship](https://arxiv.org/abs/2604.06419)
*Dayeon Eom,Julianne Renner,Sedona Chinn*
...
### [58] [Breaking Negative Cycles: A Reflection-To-Action System For Adaptive Change](https://arxiv.org/abs/2604.06477)
...
### [59] [Language-Guided Multimodal Texture Authoring via Generative Models](https://arxiv.org/abs/2604.06489)
...
### [60] [Meaningful Human Command: Towards a New Model for Military Human-Robot Interaction](https://arxiv.org/abs/2604.06611)
...
### [61] [MemoryDiorama: Generating Dynamic 3D Diorama from Everyday Photos for Memory Recall](https://arxiv.org/abs/2604.06773)
...
### [62] [Physics-driven Sonification for Improving Multisensory Needle Guidance in Percutaneous Epicardial Access](https://arxiv.org/abs/2604.06911)
...
### [63] [BioMoTouch: Touch-Based Behavioral Authentication via Biometric-Motion Interaction Modeling](https://arxiv.org/abs/2604.07071)
...
### [64] [Workmanship of Learning: Embedding Craftsmanship Values in AI-Integrated Educational Tools](https://arxiv.org/abs/2604.07118)
...
### [65] [Mixed-Initiative Context: Structuring and Managing Context for Human-AI Collaboration](https://arxiv.org/abs/2604.07121)
...
### [66] [Critical Inker: Scaffolding Critical Thinking in AI-Assisted Writing Through Socratic Questioning](https://arxiv.org/abs/2604.07167)
...
### [67] [Reshaping Inclusive Interpersonal Dynamics through Smart Glasses in Mixed-Vision Social Activities](https://arxiv.org/abs/2604.07232)
...
### [68] [BATON: A Multimodal Benchmark for Bidirectional Automation Transition Observation in Naturalistic Driving](https://arxiv.org/abs/2604.07263)
...
### [69] [Mapping Child Malnutrition and Measuring Efficiency of Community Healthcare Workers through Location Based Games in India](https://arxiv.org/abs/2604.07299)
...
### [70] [NIRVANA: A Comprehensive Dataset for Reproducing How Students Use Generative AI for Essay Writing](https://arxiv.org/abs/2604.07344)
