...
### [14] [Beyond Centralization: User-Controlled Federated Recommendations in Practice](https://arxiv.org/abs/2605.12527)
...
### [15] [MLPs are Efficient Distilled Generative Recommenders](https://arxiv.org/abs/2605.12617)
...
### [16] [EcoGEO: Trajectory-Aware Evidence Ecosystems for Web-Enabled LLM Search Agents](https://arxiv.org/abs/2605.12887)
...
### [17] [Same Image, Different Meanings: Toward Retrieval of Context-Dependent Meanings](https://arxiv.org/abs/2605.12905)
...
### [18] [RAG-Enhanced Large Language Models for Dynamic Content Expiration Prediction in Web Search](https://arxiv.org/abs/2605.13052)
...
### [19] [A Standardized Re-evaluation of Conversational Recommender Systems on the ReDial Dataset](https://arxiv.org/abs/2605.13053)
...
### [20] [LeanSearch v2: Global Premise Retrieval for Lean 4 Theorem Proving](https://arxiv.org/abs/2605.13137)
...
### [21] [Granite Embedding Multilingual R2 Models](https://arxiv.org/abs/2605.13521)
...
### [22] [Benchmarking the Open Science Data Federation services to develop XRootD best practices](https://arxiv.org/abs/2605.13593)
...
### [23] [Can LLM Agents Simulate Dynamic Networks? A Case Study on Email Networks with Phishing Synthesis](https://arxiv.org/abs/2605.12507)
...
### [24] [Interoperability Effects: Extending DeFi Lending Risk Models to Multi-Chain Environments](https://arxiv.org/abs/2605.12508)
*Hasret Ozan Sevim*
...
### [25] [Representing Higher-Order Networks: A Survey of Graph-Based Frameworks](https://arxiv.org/abs/2605.12509)
...
### [26] [WhatsApp Vaccine Discourse (WhaVax): An Expert-Annotated Dataset and Benchmark for Health Misinformation Detection](https://arxiv.org/abs/2605.12510)
...
### [27] [Real-World Challenges in Fake News Detection: Dealing with Posts by Cold Users](https://arxiv.org/abs/2605.12511)
...
### [28] [Beyond Individual Mimicry: Constructing Human-Like Social network with Graph-Augmented LLM Agents](https://arxiv.org/abs/2605.12512)
...
### [29] [SP-GCRL: Influence Maximization on Incomplete Social Graphs](https://arxiv.org/abs/2605.12513)
...
### [30] [Structural Diversity Drives Disruptive Scientific Innovation](https://arxiv.org/abs/2605.12514)
...
### [31] [PERCEIVE: A Benchmark for Personalized Emotion and Communication Behavior Understanding on Social Media](https://arxiv.org/abs/2605.12525)
...
### [32] ["F*** You Biden": Cross-Partisan Electoral Toxicity on X](https://arxiv.org/abs/2605.12526)
...
### [33] [Linking Extreme Discourse to Structural Polarization in Signed Interaction Networks](https://arxiv.org/abs/2605.12814)
...
### [34] [When Do LLMs Generate Realistic Social Networks? A Multi-Dimensional Study of Culture, Language, Scale, and Method](https://arxiv.org/abs/2605.12898)
...
### [35] [Think Twice, Act Once: Verifier-Guided Action Selection For Embodied Agents](https://arxiv.org/abs/2605.12620)
...
### [37] [Do Androids Dream of Breaking the Game? Systematically Auditing AI Agent Benchmarks with BenchJack](https://arxiv.org/abs/2605.12673)
...
### [38] [Revealing Interpretable Failure Modes of VLMs](https://arxiv.org/abs/2605.12674)
...
### [39] [Learning Transferable Latent User Preferences for Human-Aligned Decision Making](https://arxiv.org/abs/2605.12682)
...
### [40] [On the Size Complexity and Decidability of First-Order Progression](https://arxiv.org/abs/2605.12691)
...
### [41] [DisaBench: A Participatory Evaluation Framework for Disability Harms in Language Models](https://arxiv.org/abs/2605.12702)
...
### [42] [CHAL: Council of Hierarchical Agentic Language](https://arxiv.org/abs/2605.12718)
...
### [43] [BEHAVE: A Hybrid AI Framework for Real-Time Modeling of Collective Human Dynamics](https://arxiv.org/abs/2605.12730)
*Helene Malyutina*
...
### [44] [State-Centric Decision Process](https://arxiv.org/abs/2605.12755)
...
### [45] [PROMETHEUS: Automating Deep Causal Research Integrating Text, Data and Models](https://arxiv.org/abs/2605.12835)
*Sridhar Mahadevan*
...
### [46] [Retrieval-Augmented Tutoring for Algorithm Tracing and Problem-Solving in AI Education](https://arxiv.org/abs/2605.12988)
...
### [47] [Multimodal Hidden Markov Models for Persistent Emotional State Tracking](https://arxiv.org/abs/2605.12838)
...
### [48] [Assessing the Creativity of Large Language Models: Testing, Limits, and New Frontiers](https://arxiv.org/abs/2605.13450)
...
### [49] [IdeaForge: A Knowledge Graph-Grounded Multi-Agent Framework for Cross-Methodology Innovation Analysis and Patent Claim Generation](https://arxiv.org/abs/2605.13311)
*Joy Bose*
...
### [50] [Moltbook Moderation: Uncovering Hidden Intent Through Multi-Turn Dialogue](https://arxiv.org/abs/2605.12856)
...
### [51] [AI-Generated Slides: Are They Good? Can Students Tell?](https://arxiv.org/abs/2605.13532)
...
### [52] [Beyond Cooperative Simulators: Generating Realistic User Personas for Robust Evaluation of LLM Agents](https://arxiv.org/abs/2605.12894)
...
### [53] [When Attention Closes: How LLMs Lose the Thread in Multi-Turn Interaction](https://arxiv.org/abs/2605.12922)
...
### [54] [ScioMind: Cognitively Grounded Multi-Agent Social Simulation with Anchoring-Based Belief Dynamics and Dynamic Profiles](https://arxiv.org/abs/2605.13725)
...
### [55] [Sustaining AI safety: Control-theoretic external impossibility, intrinsic necessity, and structural requirements](https://arxiv.org/abs/2605.12963)
*James M. Mazzu*
...
### [56] [Position: Agentic AI System Is a Foreseeable Pathway to AGI](https://arxiv.org/abs/2605.12966)
...
### [57] [Retrieval is Cheap, Show Me the Code: Executable Multi-Hop Reasoning for Retrieval-Augmented Generation](https://arxiv.org/abs/2605.12975)
...
### [58] [Useful Memories Become Faulty When Continuously Updated by LLMs](https://arxiv.org/abs/2605.12978)
...
### [59] [MAP: A Map-then-Act Paradigm for Long-Horizon Interactive Agent Reasoning](https://arxiv.org/abs/2605.13037)
...
### [60] [An Agentic LLM-Based Framework for Population-Scale Mental Health Screening](https://arxiv.org/abs/2605.13046)
...
### [61] [GRACE: Gradient-aligned Reasoning Data Curation for Efficient Post-training](https://arxiv.org/abs/2605.13130)
...
### [62] [A Constraint Programming Approach for $n$-Day Lookahead Playoff Clinching](https://arxiv.org/abs/2605.13142)
...
### [63] [Formal Conjectures: An Open and Evolving Benchmark for Verified Discovery in Mathematics](https://arxiv.org/abs/2605.13171)
...
### [65] [An Agentic AI Framework with Large Language Models and Chain-of-Thought for UAV-Assisted Logistics Scheduling with Mobile Edge Computing](https://arxiv.org/abs/2605.13221)
...
### [66] [Improving Code Translation with Syntax-Guided and Semantic-aware Preference Optimization](https://arxiv.org/abs/2605.13229)
...
### [67] [It's not the Language Model, it's the Tool: Deterministic Mediation for Scientific Workflows](https://arxiv.org/abs/2605.13245)
...
### [68] [Respecting Self-Uncertainty in On-Policy Self-Distillation for Efficient LLM Reasoning](https://arxiv.org/abs/2605.13255)
...
### [69] [D-VLA: A High-Concurrency Distributed Asynchronous Reinforcement Learning Framework for Vision-Language-Action Models](https://arxiv.org/abs/2605.13276)
...
### [70] [Differentiable Learning of Lifted Action Schemas for Classical Planning](https://arxiv.org/abs/2605.13282)
...
### [71] [What properties of reasoning supervision are associated with improved downstream model quality?](https://arxiv.org/abs/2605.13290)
...
### [72] [Achieving Gold-Medal-Level Olympiad Reasoning via Simple and Unified Scaling](https://arxiv.org/abs/2605.13301)
...
### [73] [VERA-MH: Validation of Ethical and Responsible AI in Mental Health](https://arxiv.org/abs/2605.13318)
...
### [74] [Diversity of Extensions in Abstract Argumentation](https://arxiv.org/abs/2605.13332)
...
### [75] [Ego2World: Compiling Egocentric Cooking Videos into Executable Worlds for Belief-State Planning](https://arxiv.org/abs/2605.13335)
...
### [76] [Multi-Agent Systems in Emergency Departments: Validation Study on a ED Digital Twin](https://arxiv.org/abs/2605.13345)
...
### [77] [RS-Claw: Progressive Active Tool Exploration via Hierarchical Skill Trees for Remote Sensing Agents](https://arxiv.org/abs/2605.13391)
...
### [78] [TRIAGE: Evaluating Prospective Metacognitive Control in LLMs under Resource Constraints](https://arxiv.org/abs/2605.13414)
...
### [79] [Cognifold: Always-On Proactive Memory via Cognitive Folding](https://arxiv.org/abs/2605.13438)
...
### [80] [MMSkills: Towards Multimodal Skills for General Visual Agents](https://arxiv.org/abs/2605.13527)
...
### [81] [Scaling Retrieval-Augmented Reasoning with Parallel Search and Explicit Merging](https://arxiv.org/abs/2605.13534)
...
### [82] [RealICU: Do LLM Agents Understand Long-Context ICU Data? A Benchmark Beyond Behavior Imitation](https://arxiv.org/abs/2605.13542)
...
### [83] [Learning Local Constraints for Reinforcement-Learned Content Generators](https://arxiv.org/abs/2605.13570)
...
### [84] [Position: Assistive Agents Need Accessibility Alignment](https://arxiv.org/abs/2605.13579)
...
### [85] [Unweighted ranking for value-based decision making with uncertainty](https://arxiv.org/abs/2605.13601)
...
### [86] [How to Interpret Agent Behavior](https://arxiv.org/abs/2605.13625)
...
### [87] [Adaptive mine planning under geological uncertainty: A POMDP framework for sequential decision-making](https://arxiv.org/abs/2605.13702)
...
### [88] [Senses Wide Shut: A Representation-Action Gap in Omnimodal LLMs](https://arxiv.org/abs/2605.13737)
...
### [89] [Harnessing Agentic Evolution](https://arxiv.org/abs/2605.13821)
...
### [90] [History Anchors: How Prior Behavior Steers LLM Decisions Toward Unsafe Actions](https://arxiv.org/abs/2605.13825)
...
### [91] [Quantifying Sensitivity for Tree Ensembles: A symbolic and compositional approach](https://arxiv.org/abs/2605.13830)
