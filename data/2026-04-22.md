...
### [34] [Integrating Anomaly Detection into Agentic AI for Proactive Risk Management in Human Activity](https://arxiv.org/abs/2604.19538)
...
### [46] [Dual-View Training for Instruction-Following Information Retrieval](https://arxiv.org/abs/2604.18845)
...
### [47] [STK-Adapter: Incorporating Evolving Graph and Event Chain for Temporal Knowledge Graph Extrapolation](https://arxiv.org/abs/2604.19042)
...
### [48] [Think Before Writing: Feature-Level Multi-Objective Optimization for Generative Citation Visibility](https://arxiv.org/abs/2604.19113)
...
### [49] [GraphRAG-IRL: Personalized Recommendation with Graph-Grounded Inverse Reinforcement Learning and LLM Re-ranking](https://arxiv.org/abs/2604.19128)
...
### [50] [CS3: Efficient Online Capability Synergy for Two-Tower Recommendation](https://arxiv.org/abs/2604.19269)
...
### [51] [CAST: Modeling Semantic-Level Transitions for Complementary-Aware Sequential Recommendation](https://arxiv.org/abs/2604.19414)
...
### [52] [Enhancing Unsupervised Keyword Extraction in Academic Papers through Integrating Highlights with Abstract](https://arxiv.org/abs/2604.19505)
...
### [53] [LoopCTR: Unlocking the Loop Scaling Power for Click-Through Rate Prediction](https://arxiv.org/abs/2604.19550)
...
### [54] [Diagnosable ColBERT: Debugging Late-Interaction Retrieval Models Using a Learned Latent Space as Reference](https://arxiv.org/abs/2604.19566)
*François Remy*
...
### [55] [From Top-1 to Top-K: A Reproducibility Study and Benchmarking of Counterfactual Explanations for Recommender Systems](https://arxiv.org/abs/2604.19663)
...
### [56] [ECLASS-Augmented Semantic Product Search for Electronic Components](https://arxiv.org/abs/2604.19664)
...
### [57] [CentaurTA Studio: A Self-Improving Human-Agent Collaboration System for Thematic Analysis](https://arxiv.org/abs/2604.18589)
...
### [58] [Critical Thinking in the Age of Artificial Intelligence: A Survey-Based Study with Machine Learning Insights](https://arxiv.org/abs/2604.18590)
...
### [59] [SPRITE: From Static Mockups to Engine-Ready Game UI](https://arxiv.org/abs/2604.18591)
...
### [60] [Input Visualizations to Track Health Data by Older Adults with Multiple Chronic Conditions](https://arxiv.org/abs/2604.18741)
...
### [61] [AffectCity: An Empirical Investigation of Complexity, Transparency, and Materiality in Shaping Affective Perception of Building Facades](https://arxiv.org/abs/2604.18768)
...
### [62] [The Triadic Loop: A Framework for Negotiating Alignment in AI Co-hosted Livestreaming](https://arxiv.org/abs/2604.18850)
...
### [63] [Choose Your Own Adventure: Non-Linear AI-Assisted Programming with EvoGraph](https://arxiv.org/abs/2604.18883)
...
### [64] [Relationships Between Trust, Compliance, and Performance for Novice Programmers Using AI Code Generation](https://arxiv.org/abs/2604.18948)
...
### [65] [Physical and Augmented Reality based Playful Activities for Refresher Training of ASHA Workers in India](https://arxiv.org/abs/2604.18959)
...
### [66] [Analysis of AWW (Anganwadi Workers) Training Content, ILA (Incremental Learning Approach) Modules Following CDT (Component Display Theory)](https://arxiv.org/abs/2604.19032)
...
### [67] [Cultural Newcomers Dining Across Borders: Need-Based Design Envision of Mixed Media Integration in MR for Foreign Menu Understanding and Ordering](https://arxiv.org/abs/2604.19088)
...
### [68] [Relational AI in Education: Reciprocity, Participatory Design, and Indigenous Worldviews](https://arxiv.org/abs/2604.19099)
...
### [69] [Revisiting Framing Codebooks with AI: Employing Large Language Models as Analytical Collaborators in Deductive Content Analysis](https://arxiv.org/abs/2604.19111)
...
### [70] [OOPrompt: Reifying Intents into Structured Artifacts for Modular and Iterative Prompting](https://arxiv.org/abs/2604.19114)
...
### [71] [BONSAI: A Mixed-Initiative Workspace for Human-AI Co-Development of Visual Analytics Applications](https://arxiv.org/abs/2604.19247)
...
### [72] [Designing Transparent AI-Mediated Language Support for Intergenerational Family Communication](https://arxiv.org/abs/2604.19276)
...
### [73] [Beyond Semantic Similarity: A Component-Wise Evaluation Framework for Medical Question Answering Systems with Health Equity Implications](https://arxiv.org/abs/2604.19281)
...
### [74] [Co-Refine: AI-Powered Tool Supporting Qualitative Analysis](https://arxiv.org/abs/2604.19309)
...
### [75] [VIVA Stimuli: A Web-Based Platform for Eye Tracking Stimuli](https://arxiv.org/abs/2604.19397)
...
### [76] [Understanding Password Preferences, Memorability, and Security through a Human-Centered Lens](https://arxiv.org/abs/2604.19410)
...
### [77] [MER 2026: From Discriminative Emotion Recognition to Generative Emotion Understanding](https://arxiv.org/abs/2604.19417)
...
### [78] [Allow Me Into Your Dream: A Handshake-and-Pull Protocol for Sharing Mixed Realities in Spontaneous Encounters](https://arxiv.org/abs/2604.19423)
...
### [79] [Seeing Your Mindless Face: How Viewing One's Live Self Interrupts Mindless Short-Form Video Scrolling](https://arxiv.org/abs/2604.19424)
...
### [80] [seneca: A Personalized Conversational Planner](https://arxiv.org/abs/2604.19425)
...
### [81] [Discerning Authorship in Online Health Communities: Experience, Trust, and Transparency Implications for Moderating AI](https://arxiv.org/abs/2604.19429)
...
### [82] [Translating Ethical Frameworks Into User-Centred Anti-Social Behaviour Interventions](https://arxiv.org/abs/2604.19492)
...
### [83] [InvestChat: Exploring Multimodal Interaction via Natural Language, Touch, and Pen in an Investment Dashboard](https://arxiv.org/abs/2604.19537)
...
### [84] [Remindful: Designing Reminder Systems for Caregiver Interpretation in Dementia Care](https://arxiv.org/abs/2604.19574)
...
### [85] [Modelling and Analysing Behaviours and Emotions via Complex User Interactions](https://arxiv.org/abs/1902.07683)
*Mohamed Mostafa*
