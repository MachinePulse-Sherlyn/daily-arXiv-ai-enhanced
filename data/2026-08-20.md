...
### [16] [Redakto - The Incognito Tab for LLMs](https://arxiv.org/abs/2608.18260)
...
### [17] [FraudBench: Stress-Testing Policy-Grounded Banking Agents Against Adaptive Fraud](https://arxiv.org/abs/2608.18136)
...
### [18] [Evaluating Structured Information Extraction with Open Models in a High Risk Public Sector Application](https://arxiv.org/abs/2608.18289)
...
### [21] [ComponentBench: Diagnosing Component-Level Failures in Computer-Use Agents](https://arxiv.org/abs/2608.18307)
...
### [22] [FinRCA-Bench: Benchmarking Evidence Retrieval and Reasoning for Financial AI Systems](https://arxiv.org/abs/2608.18534)
*Pratik Ghawate*
...
### [23] [Adversarial Review: Structured Disagreement for Grounded Agentic Code Review](https://arxiv.org/abs/2608.18167)
...
### [25] [On the Triangle Inequality for the Jaccard Distance in Arbitrary Lattices](https://arxiv.org/abs/2608.18194)
...
### [26] [GenEx: A Graph-Based Representational Paradigm for SARS-CoV-2 Variant Detection via Codon Co-occurrence Networks](https://arxiv.org/abs/2608.18238)
...
### [30] [Governance Records as Supervision: Verifier-Selected Self-Training for Structured Workflow Repair](https://arxiv.org/abs/2608.18324)
*Jesus Salas*
...
### [31] [Measuring the Partial-Credit Gap: A Strict Benchmark on Vietnam's 2025 Convex Marking Scheme](https://arxiv.org/abs/2608.18336)
...
### [32] [A Jagged Frontier: Evaluating Robustness of Code Agents to Semantics-Preserving Transformations](https://arxiv.org/abs/2608.18389)
...
### [34] [Improving Natural-Language Combinatorial-Optimization Accuracy in Resource-Constrained Language Models via Formal Abstractions](https://arxiv.org/abs/2608.18409)
...
### [37] [Which Negatives Matter? Ask Your Text Encoder: Adaptive Similarity Margins for Dense-Caption Retrieval](https://arxiv.org/abs/2608.18521)
...
### [38] [Pairwise Ranking Outperforms Single-Action RL for Offline Explanation Selection: A Practical Lesson](https://arxiv.org/abs/2608.18531)
...
### [68] [LEDGER: Claim-to-Evidence Trace Graphs for Auditing LLM Agents](https://arxiv.org/abs/2608.18398)
...
### [69] [Multimodal Rapport Estimation in Real-World HRI](https://arxiv.org/abs/2608.18401)
...
### [70] [Reducing Technician Search Burden: A Multimodal RAG for Cessna 172 Maintenance Manual](https://arxiv.org/abs/2608.18465)
...
### [71] [Designing Social Robots for Social-Cognition Training with Autistic Adults](https://arxiv.org/abs/2608.18488)
...
### [72] [Measuring Proof Burden in Public Bounty Listings: A RentAHuman Case Study](https://arxiv.org/abs/2608.18547)
*Iman YeckehZaare*
...
### [73] [SemanticSlider3D: Training-Free Continuous Semantic Editing for 3D Objects](https://arxiv.org/abs/2608.18560)
...
### [74] [Report on The 1st Workshop on Human-Centered Proactive and Personalized Agents for Interactive Information Access at CHIIR 2026](https://arxiv.org/abs/2608.18638)
...
### [75] [Sounds Uncertain: Exploring the Affective Aspects of Sonification for Uncertainty Visualization](https://arxiv.org/abs/2608.18680)
...
### [76] [Model Literacy: An Extra Summative Evaluation Factor for Visual Analytics](https://arxiv.org/abs/2608.18721)
...
### [77] [Engineering Psychological Safety in Autonomous Vehicles: A Systems-Theoretic Framework for Psychological Safety in Autonomous Vehicles and its Validation in Real-World Scenarios](https://arxiv.org/abs/2608.18778)
...
### [78] [Scoring and Gamification to Encourage Sustainable Use of Compute Clusters](https://arxiv.org/abs/2608.18786)
...
### [79] [A revised framework for the assessment of psychological safety in autonomous vehicles](https://arxiv.org/abs/2608.18801)
*Yandika Sirgabsou,Benjamin Hardin,François Leblanc,Efi Raili,David Jackson,Pericle Salvini,Lars Kunze,Marina Jirotka*
...
### [80] [TractorBeam: Personalized AI Sensemaking Support via Collaborative Machine Annotation](https://arxiv.org/abs/2608.18994)
...
### [81] [When Readability and Source Retention Diverge: An Evaluability Gap in AI Translation](https://arxiv.org/abs/2608.19083)
...
### [82] [Trade-offs in Data Color Palette Design Tools](https://arxiv.org/abs/2608.19148)
...
### [83] [Global Crises and National Policies: A Large Scale Analysis of Political Content in German Language Online Media](https://arxiv.org/abs/2608.18268)
...
### [84] [Multimedia Asset Personalization via Multimodal Embeddings at Netflix](https://arxiv.org/abs/2608.18322)
...
### [85] [AI in Search Reduces Publisher Referrals Without Improving User Experience: Experimental Evidence](https://arxiv.org/abs/2608.18352)
...
### [86] [More Context, Same Budget: Dual-Bounded Relational Recall Beyond Top-K Retrieval](https://arxiv.org/abs/2608.18448)
*Thomson D. Nguy*
...
### [87] [OneModel: A Unified Foundation for Platform-Scale Multi-Scenario Ranking](https://arxiv.org/abs/2608.18606)
...
### [88] [PILOT Technical Report](https://arxiv.org/abs/2608.18637)
...
### [89] [GreekBarRetrieval: A Benchmark for Greek Statutory Retrieval](https://arxiv.org/abs/2608.18752)
...
### [90] [GateDiffInt: Gate-Mediated Controllable Diffusion and Multi-Intent LLM Distillation for User Behavior Modeling](https://arxiv.org/abs/2608.18764)
...
### [91] [SIDScope: A Diagnostic Resource for Semantic-ID Interfaces in Generative Recommendation](https://arxiv.org/abs/2608.18779)
...
### [92] [Think-to-Personalize: Unifying Reasoning and Retrieval for User-Centric Personalized Dense Retrieval](https://arxiv.org/abs/2608.18855)
...
### [93] [rEDMRec: Distilling Large Language Model Reasoning into an Editable Experience Memory for Recommendation](https://arxiv.org/abs/2608.18952)
...
### [94] [Longitudinal Relational Publics and their Discursive Overlap with Issue Publics](https://arxiv.org/abs/2608.18422)
...
### [95] [Comparing Probabilistic Influence-Spreading Centralities to Commonly-Used Centrality Measures in Directed and Weighted Networks](https://arxiv.org/abs/2608.18797)
