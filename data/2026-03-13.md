...
### [16] [Increasing intelligence in AI agents can worsen collective outcomes](https://arxiv.org/abs/2603.12129)
*Neil F. Johnson*
...
### [17] [The Artificial Self: Characterising the landscape of AI identity](https://arxiv.org/abs/2603.11353)
...
### [18] [Detecting Intrinsic and Instrumental Self-Preservation in Autonomous Agents: The Unified Continuation-Interest Protocol](https://arxiv.org/abs/2603.11382)
*Christopher Altman*
...
### [24] [Verified Multi-Agent Orchestration: A Plan-Execute-Verify-Replan Framework for Complex Query Resolution](https://arxiv.org/abs/2603.11445)
...
### [64] [An Intelligent Hybrid Cross-Entropy System for Maximising Network Homophily via Soft Happy Colouring](https://arxiv.org/abs/2603.11050)
...
### [65] [A Survey on Quantitative Modeling of Trust in Online Social Networks](https://arxiv.org/abs/2603.11054)
...
### [66] [Cross-Platform Digital Discourse Analysis of Iran: Topics, Sentiment, Polarization, and Event Validation on Telegram and Reddit](https://arxiv.org/abs/2603.11057)
...
### [67] [Uncertainty-Aware Estimation of Mis/Disinformation Prevalence on Social Media](https://arxiv.org/abs/2603.11058)
...
### [68] [Identifying the Group to Intervene on to Maximise Effect Under Cross-Group Interference](https://arxiv.org/abs/2603.11059)
...
### [69] [LLY Ricci Reweighting in Stochastic Block Models: Uniform Curvature Concentration and Finite-Horizon Tracking](https://arxiv.org/abs/2603.11060)
*Varun Kotharkar*
...
### [70] [LLMs Can Infer Political Alignment from Online Conversations](https://arxiv.org/abs/2603.11253)
...
### [71] [How do AI agents talk about science and research? An exploration of scientific discussions on Moltbook using BERTopic](https://arxiv.org/abs/2603.11375)
*Oliver Wieczorek*
...
### [72] [HawkesRank: Event-Driven Centrality for Real-Time Importance Ranking](https://arxiv.org/abs/2603.11472)
...
### [73] [Credibility Matters: Motivations, Characteristics, and Influence Mechanisms of Crypto Key Opinion Leaders](https://arxiv.org/abs/2603.12000)
...
### [74] [Opinion Dynamics in Learning Systems](https://arxiv.org/abs/2603.12137)
...
### [75] [OpenSanctions Pairs: Large-Scale Entity Matching with LLMs](https://arxiv.org/abs/2603.11051)
...
### [76] [Reproducible Synthetic Clinical Letters for Seizure Frequency Information Extraction](https://arxiv.org/abs/2603.11407)
...
### [77] [Quantized Inference for OneRec-V2](https://arxiv.org/abs/2603.11486)
...
### [78] [Federated Learning and Unlearning for Recommendation with Personalized Data Sharing](https://arxiv.org/abs/2603.11610)
...
### [79] [Enhancing Music Recommendation with User Mood Input](https://arxiv.org/abs/2603.11796)
*Terence Zeng*
...
### [80] [The Laziness of the Crowd: Effort Aversion Among Raters Risks Undermining the Efficacy of X's Community Notes Program](https://arxiv.org/abs/2603.11120)
...
### [81] [LLMs in social services: How does chatbot accuracy affect human accuracy?](https://arxiv.org/abs/2603.11213)
...
### [82] [Understanding User Perceptions of Human-centered AI-Enhanced Support Group Formation in Online Healthcare Communities](https://arxiv.org/abs/2603.11237)
...
### [83] [Modeling Trial-and-Error Navigation With a Sequential Decision Model of Information Scent](https://arxiv.org/abs/2603.11759)
...
### [84] ["I followed what felt right, not what I was told": Autonomy, Coaching, and Recognizing Bias Through AI-Mediated Dialogue](https://arxiv.org/abs/2603.11274)
...
### [85] [Bridging the Cognitive Gap: Co-Designing and Evaluating a Voice-Enabled Community Chatbot for Older Adults](https://arxiv.org/abs/2603.11303)
...
### [86] [Ghost Framing Theory: Exploring the role of generative AI in new venture rhetorical legitimation](https://arxiv.org/abs/2603.11384)
*Greg Nyilasy*
...
### [87] [To Believe or Not To Believe: Comparing Supporting Information Tools to Aid Human Judgments of AI Veracity](https://arxiv.org/abs/2603.11393)
...
### [88] [Evaluation format, not model capability, drives triage failure in the assessment of consumer health AI](https://arxiv.org/abs/2603.11413)
...
### [89] [Managing Cognitive Bias in Human Labeling Operations for Rare-Event AI: Evidence from a Field Experiment](https://arxiv.org/abs/2603.11511)
...
### [90] [From Pen Strokes to Sleep States: Detecting Low-Recovery Days Using Sigma-Lognormal Handwriting Features](https://arxiv.org/abs/2603.11512)
...
### [91] [Prediction of Grade, Gender, and Academic Performance of Children and Teenagers from Handwriting Using the Sigma-Lognormal Model](https://arxiv.org/abs/2603.11519)
...
### [92] [Shadowless Projection Mapping for Tabletop Workspaces with Synthetic Aperture Projector](https://arxiv.org/abs/2603.11551)
...
### [93] [Modeling Sequential Design Actions as Designer Externalization on an Infinite Canvas](https://arxiv.org/abs/2603.11569)
...
### [94] [High-Contrast Projection Mapping under Light Field Illumination with LED Display and Aperiodic Lens Array](https://arxiv.org/abs/2603.11573)
...
### [95] [From Pets to Robots: MojiKit as a Data-Informed Toolkit for Affective HRI Design](https://arxiv.org/abs/2603.11632)
...
### [96] [From Control to Foresight: Simulation as a New Paradigm for Human-Agent Collaboration](https://arxiv.org/abs/2603.11677)
...
### [97] [PhiPlot: A Web-Based Interactive EDA Environment for Atmospherically Relevant Molecules](https://arxiv.org/abs/2603.11751)
...
### [98] [HiSync: Spatio-Temporally Aligning Hand Motion from Wearable IMU and On-Robot Camera for Command Source Identification in Long-Range HRI](https://arxiv.org/abs/2603.11809)
...
### [99] [Stuck on Suggestions: Automation Bias, the Anchoring Effect, and the Factors That Shape Them in Computational Pathology](https://arxiv.org/abs/2603.11821)
...
### [100] [Design Exploration of Lightweight Interactions for Awareness-Supporting Technologies in Hybrid Work](https://arxiv.org/abs/2603.11977)
...
### [101] [ConvScale: Conversational Interviews for Scale-Aligned Measurement](https://arxiv.org/abs/2603.11988)
...
### [102] [An Intent of Collaboration: On Agencies between Designers and Emerging (Intelligent) Technologies](https://arxiv.org/abs/2603.12018)
...
### [103] [Human-Centred LLM Privacy Audits: Findings and Frictions](https://arxiv.org/abs/2603.12094)
...
### [104] [UniMotion: Self-Supervised Learning for Cross-Domain IMU Motion Recognition](https://arxiv.org/abs/2603.12218)
