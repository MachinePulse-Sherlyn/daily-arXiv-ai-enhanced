...
### [2] [Relevance Matters: A Multi-Task and Multi-Stage Large Language Model Approach for E-commerce Query Rewriting](https://arxiv.org/abs/2603.02555)
...
### [3] [SOLAR: SVD-Optimized Lifelong Attention for Recommendation](https://arxiv.org/abs/2603.02561)
...
### [4] [FlashEvaluator: Expanding Search Space with Parallel Evaluation](https://arxiv.org/abs/2603.02565)
...
### [5] [AlphaFree: Recommendation Free from Users, IDs, and GNNs](https://arxiv.org/abs/2603.02653)
...
### [6] [S2CDR: Smoothing-Sharpening Process Model for Cross-Domain Recommendation](https://arxiv.org/abs/2603.02725)
...
### [7] [APAO: Adaptive Prefix-Aware Optimization for Generative Recommendation](https://arxiv.org/abs/2603.02730)
...
### [8] [Model Editing for New Document Integration in Generative Information Retrieval](https://arxiv.org/abs/2603.02773)
...
### [9] [OneRanker: Unified Generation and Ranking with One Model in Industrial Advertising Recommendation](https://arxiv.org/abs/2603.02999)
...
### [10] [Reproducing and Comparing Distillation Techniques for Cross-Encoders](https://arxiv.org/abs/2603.03010)
...
### [11] [Proactive Guiding Strategy for Item-side Fairness in Interactive Recommendation](https://arxiv.org/abs/2603.03094)
...
### [12] [Federated Inference: Toward Privacy-Preserving Collaborative and Incentivized Model Serving](https://arxiv.org/abs/2603.02214)
...
### [13] [Engineering Reasoning and Instruction (ERI) Benchmark: A Large Taxonomy-driven Dataset for Foundation Models and Agents](https://arxiv.org/abs/2603.02239)
...
### [14] [SuperLocalMemory: Privacy-Preserving Multi-Agent Memory with Bayesian Trust Defense Against Memory Poisoning](https://arxiv.org/abs/2603.02240)
...
### [15] [Estimating Visual Attribute Effects in Advertising from Observational Data: A Deepfake-Informed Double Machine Learning Approach](https://arxiv.org/abs/2603.02359)
...
### [16] [Can machines be uncertain?](https://arxiv.org/abs/2603.02365)
*Luis Rosa*
...
### [17] [COOL-MC: Verifying and Explaining RL Policies for Platelet Inventory Management](https://arxiv.org/abs/2603.02396)
*Dennis Gross*
...
### [18] [VL-KGE: Vision-Language Models Meet Knowledge Graph Embeddings](https://arxiv.org/abs/2603.02435)
...
### [19] [Diagnosing Retrieval vs. Utilization Bottlenecks in LLM Agent Memory](https://arxiv.org/abs/2603.02473)
...
### [20] [Revealing Positive and Negative Role Models to Help People Make Good Decisions](https://arxiv.org/abs/2603.02495)
...
### [21] [LLM-MLFFN: Multi-Level Autonomous Driving Behavior Feature Fusion via Large Language Model](https://arxiv.org/abs/2603.02528)
...
### [23] [AnchorDrive: LLM Scenario Rollout with Anchor-Guided Diffusion Regeneration for Safety-Critical Scenario Generation](https://arxiv.org/abs/2603.02542)
...
### [24] [LiveAgentBench: Comprehensive Benchmarking of Agentic Systems Across 104 Real-World Challenges](https://arxiv.org/abs/2603.02586)
...
### [25] [SUN: Shared Use of Next-token Prediction for Efficient Multi-LLM Disaggregated Serving](https://arxiv.org/abs/2603.02599)
...
### [26] [AgentAssay: Token-Efficient Regression Testing for Non-Deterministic AI Agent Workflows](https://arxiv.org/abs/2603.02601)
*Varun Pratap Bhardwaj*
...
### [42] [REGAL: A Registry-Driven Architecture for Deterministic Grounding of Agentic AI in Enterprise Telemetry](https://arxiv.org/abs/2603.03018)
*Yuvraj Agrawal*
...
### [43] [TikZilla: Scaling Text-to-TikZ with High-Quality Data and Reinforcement Learning](https://arxiv.org/abs/2603.03072)
...
### [44] [RAPO: Expanding Exploration for LLM Agents via Retrieval-Augmented Policy Optimization](https://arxiv.org/abs/2603.03078)
...
### [45] [Beyond Factual Correctness: Mitigating Preference-Inconsistent Explanations in Explainable Recommendation](https://arxiv.org/abs/2603.03080)
...
### [46] [Odin: Multi-Signal Graph Intelligence for Autonomous Discovery in Knowledge Graphs](https://arxiv.org/abs/2603.03097)
...
### [47] [Beyond Task Completion: Revealing Corrupt Success in LLM Agents through Procedure-Aware Evaluation](https://arxiv.org/abs/2603.03116)
...
### [48] [Pulli Kolam: A Traditional South Indian Craft Practice for Representing Data](https://arxiv.org/abs/2603.02343)
...
### [49] [PlayWrite: A Multimodal System for AI Supported Narrative Co-Authoring Through Play in XR](https://arxiv.org/abs/2603.02366)
...
### [50] [Strategic Shaping of Human Prosociality: A Latent-State POMDP Framework](https://arxiv.org/abs/2603.02379)
...
### [51] [A Directed Graph Model and Experimental Framework for Design and Study of Time-Dependent Text Visualisation](https://arxiv.org/abs/2603.02422)
...
### [52] [Learning to Pay Attention: Unsupervised Modeling of Attentive and Inattentive Respondents in Survey Data](https://arxiv.org/abs/2603.02427)
...
### [53] [The Perceptual Gap: Why We Need Accessible XAI for Assistive Technologies](https://arxiv.org/abs/2603.02486)
*Shadab H. Choudhury*
...
### [54] [Improving Low-Vision Chart Accessibility via On-Cursor Visual Context](https://arxiv.org/abs/2603.02498)
...
### [55] [Probing More-Than-Human Representation in Crisis Resilience Planning: An HCI Researcher Perspective](https://arxiv.org/abs/2603.02514)
...
### [56] [Understanding the Effects of Interaction on Emotional Experiences in VR](https://arxiv.org/abs/2603.02535)
...
### [57] [Orality: A Semantic Canvas for Externalizing and Clarifying Thoughts with Speech](https://arxiv.org/abs/2603.02544)
...
### [58] ['Show It, Don't Just Say It': The Complementary Effects of Instruction Multimodality for Software Guidance](https://arxiv.org/abs/2603.02567)
...
### [59] [An LLM-Assisted Toolkit for Inspectable Multimodal Emotion Data Annotation](https://arxiv.org/abs/2603.02569)
...
### [60] [Behavior-Aware Anthropometric Scene Generation for Human-Usable 3D Layouts](https://arxiv.org/abs/2603.02662)
...
### [61] ["It's Messy...But I Feel Balanced": Unpacking Flexible Workers' Rhythm-Making Practices Using an Asset-Based Approach](https://arxiv.org/abs/2603.02841)
...
### [62] [Speech recognition assisted by large language models to command software orally -- Application to an augmented and virtual reality web app for immersive molecular graphics](https://arxiv.org/abs/2603.02901)
...
### [63] [Changing Pedagogical Paradigms: Integrating Generative AI in Mathematics to Enhance Digital Literacy through 'Mathematical Battles with AI'](https://arxiv.org/abs/2603.02955)
...
### [64] [Design Generative AI for Practitioners: Exploring Interaction Approaches Aligned with Creative Practice](https://arxiv.org/abs/2603.03074)
...
### [65] [Surveillance, Spacing, Screaming and Scabbing: How Digital Technology Facilitates Union Busting](https://arxiv.org/abs/2603.03130)
...
### [66] [How to Model AI Agents as Personas?: Applying the Persona Ecosystem Playground to 41,300 Posts on Moltbook for Behavioral Insights](https://arxiv.org/abs/2603.03140)
...
### [67] [Deception by Design: A Temporal Dark Patterns Audit of McDonald's Self-Ordering Kiosk Flow](https://arxiv.org/abs/2603.03218)
