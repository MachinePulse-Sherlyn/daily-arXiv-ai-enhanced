...
### [16] [Matched Excess-Outranker Regularization for Candidate-Set Interference in Continual Knowledge Graph Embedding](https://arxiv.org/abs/2608.24273)
...
### [19] [Serving Masked Diffusion LLMs: Characterization and Design Principles from Real Hardware](https://arxiv.org/abs/2608.23807)
...
### [20] [Generating Biomedical Fact-Checking Reports with RL-Enhanced Agentic Search](https://arxiv.org/abs/2608.23811)
...
### [21] [A Formal Methodological Framework for Auditing Robustness and Fidelity in Explainable AI: From Application to Trust Certification](https://arxiv.org/abs/2608.23817)
...
### [22] [Minima-KV: Retention-Preserving KV Cache Compression with Mixed-Format Paged Attention](https://arxiv.org/abs/2608.23834)
...
### [23] [SyPS: Measuring Sycophancy Prompt Sensitivity in Large Language Models](https://arxiv.org/abs/2608.23837)
...
### [24] [Exploit More, Explore Smarter for Budget-Constrained Agentic Search](https://arxiv.org/abs/2608.23848)
...
### [25] [In-Context Inpainting for Time Series Forecasting](https://arxiv.org/abs/2608.23855)
...
### [26] [Granite.Trust Policy Tools: Shareable, Actionable Policies for Generative AI Applications](https://arxiv.org/abs/2608.23870)
...
### [27] [Semantic Overlays: Mitigating Prompt Injection with Annotations Beyond Tokens and Steering Vectors](https://arxiv.org/abs/2608.23873)
*Joshua Penman*
...
### [28] [AI Finds A Way](https://arxiv.org/abs/2608.23875)
...
### [29] [Provenance Guided Incremental Learning Under Evolving Concept Definitions](https://arxiv.org/abs/2608.23893)
*Ismail Lamaakal*
...
### [30] [BenchBench-Protocol: Evaluating Real-World Wet-Lab Protocol Reasoning and Modification](https://arxiv.org/abs/2608.23898)
...
### [31] [Quantifying System-Level Harms from AI Adoption in Complex Sociotechnical Systems](https://arxiv.org/abs/2608.23906)
...
### [32] [Retrieval-augmented generation vs. deterministic tax computation in multi-agent financial advisory: A 2x2 factorial experiment](https://arxiv.org/abs/2608.23908)
...
### [33] [PROOF-Gen: From Optimized Data to Better Distillation](https://arxiv.org/abs/2608.23911)
...
### [34] [MARS: Multi-Specialist LLM Relay System for Competitive Programming](https://arxiv.org/abs/2608.23918)
...
### [35] [Data Mixing as Mixture Experiment: Response Surface Methodology and Optimal Design for Large Language Model Pretraining](https://arxiv.org/abs/2608.23922)
...
### [36] [Evolutionary Recurrent Decision Model in Developing Adaptive and Maladaptive Behaviors](https://arxiv.org/abs/2608.23932)
*Andrew Hu*
...
### [37] [More Rejective, Not More Discriminative: The Unit of Verification in Pre-Execution LLM Oversight](https://arxiv.org/abs/2608.23941)
...
### [38] [Recursive Agentic Reasoning](https://arxiv.org/abs/2608.23956)
...
### [39] [More GPUs or a Smaller Cache? Tensor Parallelism versus KV Compression for Memory-Bound LLM Serving](https://arxiv.org/abs/2608.23962)
...
### [40] [Giraffe: A Mapping Architecture from Hidden Text Representations to Visual Embeddings for Efficient Graphic Design](https://arxiv.org/abs/2608.23970)
*Nejla Ghaboosi*
...
### [42] [Rules Before Oracles: Auditable, User-Configurable Argument Selection for Deliberative Polling](https://arxiv.org/abs/2608.23979)
...
### [118] [Degree Centrality Algorithms for Weighted Multilayer Networks (or w-MLNs)](https://arxiv.org/abs/2608.23876)
...
### [119] [AdaWidth: Query-Adaptive Embedding Width for Dense Retrieval](https://arxiv.org/abs/2608.23862)
...
### [120] [Wontopos Tablet 2: Measuring Multilingual and Multimodal Memory Retrieval Without Lexical Matching](https://arxiv.org/abs/2608.23920)
*Sunwoo Kim*
...
### [121] [Hybrid Semantic Tool Discovery for Enterprise MCP Gateway: Architecture and Implementation](https://arxiv.org/abs/2608.23992)
...
### [122] [TAGR: Temporally Adaptive Generative Recommendation for Industrial Live-Streaming Advertising](https://arxiv.org/abs/2608.24034)
...
### [123] [SQLite is Enough. Lexical, Semantic, and Hybrid Search with scrydb](https://arxiv.org/abs/2608.24060)
*Timo Breuer*
...
### [124] [RetrievalFormer: A Dual-Encoder Transformer for Efficient Approximate Nearest Neighbor Retrieval and Cold-Item Recommendation](https://arxiv.org/abs/2608.24079)
...
### [125] [CodeHID: Learning an Addressable Hierarchical Code Index for Generative Code Retrieval](https://arxiv.org/abs/2608.24089)
...
### [126] [Native Multimodal Representation Learning for Click-Through Rate Prediction in E-Commerce Scenarios](https://arxiv.org/abs/2608.24091)
...
### [127] [Tlow: Flow-based Item Tokenizer for Recommendation](https://arxiv.org/abs/2608.24176)
...
### [128] [RecGPT-Mobile-V2 Technical Report](https://arxiv.org/abs/2608.24295)
...
### [129] [Rethinking Semantic Alignment in LLM-Enhanced Collaborative Filtering: A Spectral Decoupling Approach](https://arxiv.org/abs/2608.24363)
...
### [130] [EviGraph: Towards Verifiable Evidence Construction for Information-Seeking Agents](https://arxiv.org/abs/2608.24667)
...
### [131] [Auditing Return Conditioning as a Control Knob: An Offline Diagnostic for Decision Transformer Recommendation](https://arxiv.org/abs/2608.24815)
*Jingyu Wang*
...
### [132] [Adoption Telemetry: Measuring Enterprise AI Adoption from Production Signals](https://arxiv.org/abs/2608.23617)
*Damon A. Young*
...
### [133] [The Ordinal Annotation Game: How Construct Abstraction Shapes Crowdsourced Consensus](https://arxiv.org/abs/2608.23727)
*Kosmas Pinitas*
...
### [134] [Technology Caregiving: Reframing How Older Adults Are Supported in Everyday Digital Activities](https://arxiv.org/abs/2608.23751)
...
### [135] [From Anonymous Shapes to Named Places: A Tool for Braille and Place-Semantic Annotation of Tactile Maps](https://arxiv.org/abs/2608.23820)
...
### [136] [ColorA11Y: Enhancing Creative Design Workflows with Just-in-Time Color Accessibility Recommendations](https://arxiv.org/abs/2608.23852)
...
### [137] [Who Chooses How Preferences Are Aggregated? Auditing Aggregation-Rule Authority in LLM-Based Group Recommendation](https://arxiv.org/abs/2608.23966)
*Yuxuan Du*
...
### [138] [When LLMs Slow Down: How Environmental Impacts Mediate University Students' LLM Usage](https://arxiv.org/abs/2608.23968)
...
### [139] [Negotiating Ontological Boundaries in User-Authored Personal Sensing Systems](https://arxiv.org/abs/2608.24058)
...
### [140] [Balancing Evidence and Interpretation: Historical Grounding Ratio as a Design Parameter for AI-Generated Urban Storytelling](https://arxiv.org/abs/2608.24157)
...
### [141] [Aura: Dynamic Intra-Turn Emotion-Aware Adaptation of Large Language Model Responses](https://arxiv.org/abs/2608.24224)
...
### [142] [When AI "Works," When Does Help Begin?: Intergenerational Support Around Older Adults' LLM Usage](https://arxiv.org/abs/2608.24297)
...
### [143] [How Do Professional Editors Evaluate the Editing Quality of AI-Generated Cinematic Video Ads?](https://arxiv.org/abs/2608.24329)
...
### [144] [Latent-surrealism: Revisiting surrealism and its aesthetics in relation to contemporary AI-Generated cultural production](https://arxiv.org/abs/2608.24367)
*Anca-Simona Horvath*
...
### [145] [StrokeGuard: A Multi-Agent Guided System for Prehospital Stroke Assessment](https://arxiv.org/abs/2608.24555)
...
### [146] [Shaping the Future of Generative AI for Black Communities: A Frame Analysis of Public Discourse and Empirical Scholarly Research](https://arxiv.org/abs/2608.24767)
...
### [147] [Ten Years Later: Replicating Two Color Discrimination Studies](https://arxiv.org/abs/2608.24789)
